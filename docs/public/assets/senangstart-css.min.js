...
(()=>{var w=["mob","tab","lap","desk","tw-sm","tw-md","tw-lg","tw-xl","tw-2xl"],k=["hover","focus","focus-visible","active","disabled","dark"],E=["flex","grid","block","inline","hidden","row","col","row-reverse","col-reverse","center","start","end","between","around","evenly","wrap","nowrap","absolute","relative","fixed","sticky"];function F(n){if(typeof n!="string")return"";let v=/[;]/g;return v.test(n)?n.replace(v,"_"):n}function ea(n){return!(!n.property||typeof n.property!="string"||n.property.length>100||n.value!==null&&typeof n.value!="string"||n.value&&n.value.length>500||n.breakpoint&&!w.includes(n.breakpoint)||n.state&&!k.includes(n.state))}function A(n,v){if(typeof n!="string"||n.length===0||n.length>200)return{raw:n,breakpoint:null,state:null,property:null,value:null,isArbitrary:!1,attrType:v,error:"Invalid token format"};let p={raw:n,breakpoint:null,state:null,property:null,value:null,isArbitrary:!1,attrType:v};if(v==="layout"){if(n.startsWith("z:"))return p.property="z",p.value=n.substring(2),p;if(n.startsWith("overflow:"))return p.property="overflow",p.value=n.substring(9),p;if(E.includes(n))return p.property=n,p.value=n,p;let x=n.split(":");if(x.length===2&&w.includes(x[0]))return p.breakpoint=x[0],p.property=x[1],p.value=x[1],p}let b=n.split(":");if(b.length===1)return p.property=n,p.value=n,p;let h=0;if(w.includes(b[0])&&(p.breakpoint=b[0],h++),k.includes(b[h])&&(p.state=b[h],h++),h<b.length&&(p.property=b[h],h++),h<b.length){let x=b.slice(h).join(":"),y=x.match(/^\[(.+)\]$/);y?(p.value=F(y[1].replace(/_/g," ")),p.isArbitrary=!0):p.value=F(x)}return ea(p)||(p.error="Invalid token structure"),p}function P(n){return`/* 
...
`}var K={name:"display",property:"layout",syntax:'layout="[display-value]"',description:"Control the display type of elements",descriptionMs:"Kawal jenis paparan elemen",category:"layout",values:[{value:"flex",css:"display: flex;",description:"Flexbox container",descriptionMs:"Bekas flexbox"},{value:"inline-flex",css:"display: inline-flex;",description:"Inline flexbox container",descriptionMs:"Bekas flexbox sebaris"},{value:"grid",css:"display: grid;",description:"Grid container",descriptionMs:"Bekas grid"},{value:"inline-grid",css:"display: inline-grid;",description:"Inline grid container",descriptionMs:"Bekas grid sebaris"},{value:"block",css:"display: block;",description:"Block element",descriptionMs:"Elemen blok"},{value:"inline",css:"display: inline-block;",description:"Inline block element",descriptionMs:"Elemen blok sebaris"},{value:"hidden",css:"display: none;",description:"Hidden element",descriptionMs:"Elemen tersembunyi"}],examples:[{code:'<div layout="flex">Flexbox container</div>',description:"Create a flex container"},{code:'<div layout="grid">Grid container</div>',description:"Create a grid container"},{code:'<div layout="hidden">Hidden element</div>',description:"Hide an element"}],preview:[{title:"Flexbox Container",titleMs:"Bekas Flexbox",description:"Items arranged horizontally",descriptionMs:"Item disusun secara mendatar",html:`<div layout="flex row" space="g:small p:medium" visual="bg:neutral-100 dark:bg:neutral-900 rounded:medium">
...
</div>`,highlightValue:"flex:auto"}]},G={name:"flex-basis",property:"layout",syntax:'layout="basis:[value]"',description:"Set initial size of flex item",descriptionMs:"Tetapkan saiz awal item flex",category:"layout",usesScale:"spacing",supportsArbitrary:!0,dynamic:!0,values:[{value:"auto",css:"flex-basis: auto;",description:"Auto basis",descriptionMs:"Asas automatik"},{value:"0",css:"flex-basis: 0;",description:"Zero basis",descriptionMs:"Asas sifar"}],examples:[{code:'<div layout="basis:[200px]">200px basis</div>',description:"Fixed basis"}],preview:[{title:"Fixed Basis",titleMs:"Asas Tetap",description:"Items with different basis sizes",descriptionMs:"Item dengan saiz asas berbeza",html:`<div layout="flex" space="g:small p:medium" visual="bg:neutral-100 dark:bg:neutral-900 rounded:medium">
...
</div>`,highlightValue:"basis:[100px]"}]},O={name:"order",property:"layout",syntax:'layout="order:[value]"',description:"Control flex/grid item order",descriptionMs:"Kawal susunan item flex/grid",category:"layout",dynamic:!0,values:[{value:"first",css:"order: -9999;",description:"Move to first",descriptionMs:"Pindah ke pertama"},{value:"last",css:"order: 9999;",description:"Move to last",descriptionMs:"Pindah ke terakhir"},{value:"none",css:"order: 0;",description:"Default order",descriptionMs:"Susunan lalai"},{value:"1-12",css:"order: {n};",description:"Specific order",descriptionMs:"Susunan tertentu"}],examples:[{code:'<div layout="order:first">First item</div>',description:"Move to first"}],preview:[{title:"Reorder Items",titleMs:"Susun Semula Item",description:"Change visual order of flex items",descriptionMs:"Ubah susunan visual item flex",html:`<div layout="flex" space="g:small p:medium" visual="bg:neutral-100 dark:bg:neutral-900 rounded:medium">
...
</div>`,highlightValue:"col-span:full"}]},te={name:"grid-row-span",property:"layout",syntax:'layout="row-span:[value]"',description:"Span across grid rows",descriptionMs:"Merentangi baris grid",category:"layout",dynamic:!0,values:[{value:"1-12",css:"grid-row: span {n} / span {n};",description:"Span N rows",descriptionMs:"Merentangi N baris"},{value:"full",css:"grid-row: 1 / -1;",description:"Span all rows",descriptionMs:"Merentangi semua baris"}],examples:[{code:'<div layout="row-span:2">Spans 2 rows</div>',description:"Span two rows"}],preview:[{title:"Row Span",titleMs:"Rentang Baris",description:"Item spanning multiple rows",descriptionMs:"Item merentangi berbilang baris",html:`<div layout="grid grid-cols:3 grid-rows:2" space="g:small p:medium" visual="bg:neutral-100 dark:bg:neutral-900 rounded:medium">
  ...
  <span space="p:small" visual="bg:primary text:white rounded:small" layout="text:center">3</span>
  <span space="p:small" visual="bg:primary text:white rounded:small" layout="text:center">4</span>
</div>`,highlightValue:"grid-flow:col"}]},re={name:"grid-auto-sizing",property:"layout",syntax:'layout="auto-cols:[value]" or layout="auto-rows:[value]"',description:"Control size of auto-generated grid tracks",descriptionMs:"Kawal saiz trek grid yang dijana automatik",category:"layout",dynamic:!0,values:[{value:"auto",css:"auto",description:"Auto size",descriptionMs:"Saiz automatik"},{value:"min",css:"min-content",description:"Minimum content",descriptionMs:"Kandungan minimum"},{value:"max",css:"max-content",description:"Maximum content",descriptionMs:"Kandungan maksimum"},{value:"fr",css:"minmax(0, 1fr)",description:"Fractional unit",descriptionMs:"Unit pecahan"}],examples:[{code:'<div layout="grid auto-cols:min">Auto min columns</div>',description:"Min-content columns"}],preview:[{title:"Auto Columns",titleMs:"Lajur Automatik",description:"Automatically sized column tracks",descriptionMs:"Trek lajur bersaiz automatik",html:`<div layout="grid grid-flow:col auto-cols:fr" space="g:small p:medium" visual="bg:neutral-100 dark:bg:neutral-900 rounded:medium">
...
</div>`,highlightValue:"mix-blend:multiply"}]},Ta={name:"accent-color",property:"visual",syntax:'visual="accent:[color]"',description:"Set accent color for form controls",descriptionMs:"Tetapkan warna aksen untuk kawalan borang",category:"visual",usesScale:"colors",supportsArbitrary:!0,values:[],examples:[{code:'<input type="checkbox" visual="accent:primary">',description:"Primary accent"}],preview:[{title:"Accent Color",titleMs:"Warna Aksen",description:"Style native form controls (checkboxes, radios, range)",descriptionMs:"Gaya kawalan borang asli (kotak semak, radio, julat)",html:`<div layout="flex" space="g:medium p:medium" visual="bg:neutral-100 dark:bg:neutral-900 rounded:medium">
...
</div>`,highlightValue:"from:blue-500"}]},qa={name:"gradient-via",property:"visual",syntax:'visual="via:[color]"',description:"Set gradient middle color",descriptionMs:"Tetapkan warna tengah gradien",category:"visual",usesScale:"colors",supportsArbitrary:!0,values:[{value:"purple-500",css:"--tw-gradient-via: var(--c-purple-500); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-via), var(--tw-gradient-to);",description:"Via purple",descriptionMs:"Melalui ungu"}],examples:[{code:'<div visual="bg-image:gradient-to-r from:blue-500 via:purple-500 to:pink-500">Three-color gradient</div>',description:"Three-color gradient"}],preview:[{title:"Gradient Via",titleMs:"Pertengahan Gradien",description:"Add a middle color stop to gradients",descriptionMs:"Tambah hentian warna tengah pada gradien",html:`<div layout="flex" space="g:medium p:medium" visual="bg:neutral-100 dark:bg:neutral-900 rounded:medium">
...
</div>`,highlightValue:"italic"}]},yi={name:"font-smoothing",property:"visual",syntax:'visual="[smoothing-value]"',description:"Control font smoothing",descriptionMs:"Kawal penghalusan fon",category:"visual",values:[{value:"antialiased",css:"-webkit-font-smoothing: antialiased; -moz-osx-font-smoothing: grayscale;",description:"Antialiased",descriptionMs:"Antialias"},{value:"subpixel-antialiased",css:"-webkit-font-smoothing: auto; -moz-osx-font-smoothing: auto;",description:"Subpixel antialiased",descriptionMs:"Subpixel antialias"}],examples:[{code:'<body visual="antialiased">Smooth fonts</body>',description:"Antialiased text"}],preview:[{title:"Font Smoothing",titleMs:"Penghalusan Fon",description:"Control text rendering",descriptionMs:"Kawal persembahan teks",html:`<div layout="flex" space="g:medium p:medium" visual="bg:neutral-100 dark:bg:neutral-900 rounded:medium">
...
</div>`,highlightValue:"grayscale:full"}]},Ei={name:"filter-hue-rotate",property:"visual",syntax:'visual="hue-rotate:[degrees]"',description:"Rotate hue colors",descriptionMs:"Putar warna rona",category:"visual",supportsArbitrary:!0,dynamic:!0,values:[{value:"0",css:"filter: hue-rotate(0deg);",description:"No rotation",descriptionMs:"Tiada putaran"},{value:"90",css:"filter: hue-rotate(90deg);",description:"90\xB0 rotation",descriptionMs:"Putaran 90\xB0"},{value:"180",css:"filter: hue-rotate(180deg);",description:"180\xB0 rotation",descriptionMs:"Putaran 180\xB0"}],examples:[{code:'<img visual="hue-rotate:90">Shifted hue</img>',description:"Rotate hue 90 degrees"}],preview:[{title:"Hue Rotate Filter",titleMs:"Penapis Putaran Rona",description:"Rotate color hues",descriptionMs:"Putar rona warna",html:`<div layout="flex" space="g:medium p:medium" visual="bg:neutral-100 dark:bg:neutral-900 rounded:medium">
  <div space="p:small" visual="bg:primary text:white rounded:small">0\xB0</div>
...
`,e}let{layoutMap:y,typographyKeywords:M}=Xe(),bt=w,ht=k;function Ye(r){let{property:t,value:e,isArbitrary:i}=r;if(t===e&&y[t])return y[t];if(t==="container")return"width: 100%; margin-left: auto; margin-right: auto;";if(t==="justify")return`justify-content: ${{start:"flex-start",end:"flex-end",center:"center",between:"space-between",around:"space-around",evenly:"space-evenly",stretch:"stretch"}[e]||e};`;if(t==="justify-items")return`justify-items: ${e};`;if(t==="justify-self")return`justify-self: ${e};`;if(t==="content")return`align-content: ${{start:"flex-start",end:"flex-end",center:"center",between:"space-between",around:"space-around",evenly:"space-evenly",stretch:"stretch"}[e]||e};`;if(t==="items")return`align-items: ${{start:"flex-start",end:"flex-end",center:"center",baseline:"baseline",stretch:"stretch"}[e]||e};`;if(t==="self")return`align-self: ${{auto:"auto",start:"flex-start",end:"flex-end",center:"center",baseline:"baseline",stretch:"stretch"}[e]||e};`;if(t==="place-content")return`place-content: ${{start:"start",end:"end",center:"center",between:"space-between",around:"space-around",evenly:"space-evenly",stretch:"stretch"}[e]||e};`;if(t==="place-items")return`place-items: ${e};`;if(t==="place-self")return`place-self: ${e};`;if(t==="z")return`z-index: var(--z-${e});`;if(t==="overflow")return`overflow: ${e};`;if(t==="overflow-x")return`overflow-x: ${e};`;if(t==="overflow-y")return`overflow-y: ${e};`;if(t==="aspect")return`aspect-ratio: ${i?e.replace(/_/g," "):{square:"1 / 1",video:"16 / 9",auto:"auto"}[e]||e};`;if(t==="object")return`object-fit: ${e};`;if(t==="object-pos")return`object-position: ${i?e.replace(/_/g," "):e};`;if(t==="inset")return`inset: ${i?e:e==="0"?"0":`var(--s-${e})`};`;if(["top","right","bottom","left"].includes(t)){let o=i?e:e==="0"?"0":`var(--s-${e})`;return`${t}: ${o};`}if(t==="inset-x"){let o=i?e:e==="0"?"0":`var(--s-${e})`;return`left: ${o}; right: ${o};`}if(t==="inset-y"){let o=i?e:e==="0"?"0":`var(--s-${e})`;return`top: ${o}; bottom: ${o};`}return t==="cols"?`columns: ${e};`:t==="overscroll"?`overscroll-behavior: ${e};`:t==="overscroll-x"?`overscroll-behavior-x: ${e};`:t==="overscroll-y"?`overscroll-behavior-y: ${e};`:t==="basis"?`flex-basis: ${i?e:`var(--s-${e})`};`:t==="flex"?`flex: ${i?e.replace(/_/g," "):{1:"1 1 0%",auto:"1 1 auto",initial:"0 1 auto",none:"none"}[e]||e};`:t==="order"?`order: ${{first:"-9999",last:"9999",none:"0"}[e]||e};`:t==="grid-cols"?e==="none"?"grid-template-columns: none;":e==="subgrid"?"grid-template-columns: subgrid;":i?`grid-template-columns: ${e.replace(/_/g," ")};`:`grid-template-columns: repeat(${e}, minmax(0, 1fr));`:t==="grid-rows"?e==="none"?"grid-template-rows: none;":e==="subgrid"?"grid-template-rows: subgrid;":i?`grid-template-rows: ${e.replace(/_/g," ")};`:`grid-template-rows: repeat(${e}, minmax(0, 1fr));`:t==="col-span"?e==="full"?"grid-column: 1 / -1;":`grid-column: span ${e} / span ${e};`:t==="col-start"?`grid-column-start: ${e};`:t==="col-end"?`grid-column-end: ${e};`:t==="row-span"?e==="full"?"grid-row: 1 / -1;":`grid-row: span ${e} / span ${e};`:t==="row-start"?`grid-row-start: ${e};`:t==="row-end"?`grid-row-end: ${e};`:t==="auto-cols"?`grid-auto-columns: ${i?e:{auto:"auto",min:"min-content",max:"max-content",fr:"minmax(0, 1fr)"}[e]||e};`:t==="auto-rows"?`grid-auto-rows: ${i?e:{auto:"auto",min:"min-content",max:"max-content",fr:"minmax(0, 1fr)"}[e]||e};`:t==="table"?`table-layout: ${{auto:"auto",fixed:"fixed"}[e]||e};`:t==="caption"?`caption-side: ${e};`:t==="border-spacing"?`border-spacing: ${i?e:`var(--s-${e})`};`:t==="border-spacing-x"?`border-spacing: ${i?e:`var(--s-${e})`} 0;`:t==="border-spacing-y"?`border-spacing: 0 ${i?e:`var(--s-${e})`};`:y[t]||""}function Ze(r){let{property:t,value:e,isArbitrary:i}=r;if(e==="auto")return{m:"margin: auto;","m-x":"margin-left: auto; margin-right: auto;","m-y":"margin-top: auto; margin-bottom: auto;","m-t":"margin-top: auto;","m-r":"margin-right: auto;","m-b":"margin-bottom: auto;","m-l":"margin-left: auto;"}[t]||"";let o={min:"min-content",max:"max-content",fit:"fit-content"};if(["w","h","min-w","max-w","min-h","max-h"].includes(t)&&o[e]){let m=o[e];return{w:`width: ${m};`,h:`height: ${m};`,"min-w":`min-width: ${m};`,"max-w":`max-width: ${m};`,"min-h":`min-height: ${m};`,"max-h":`max-height: ${m};`}[t]||""}let a;if(i)a=e;else{let m=e.startsWith("-"),d=m?e.substring(1):e,s;d.startsWith("tw-")?s=`var(--tw-${d.slice(3)})`:s=`var(--s-${d})`,a=m?`calc(${s} * -1)`:s}return{p:`padding: ${a};`,"p-t":`padding-top: ${a};`,"p-r":`padding-right: ${a};`,"p-b":`padding-bottom: ${a};`,"p-l":`padding-left: ${a};`,"p-x":`padding-left: ${a}; padding-right: ${a};`,"p-y":`padding-top: ${a}; padding-bottom: ${a};`,m:`margin: ${a};`,"m-t":`margin-top: ${a};`,"m-r":`margin-right: ${a};`,"m-b":`margin-bottom: ${a};`,"m-l":`margin-left: ${a};`,"m-x":`margin-left: ${a}; margin-right: ${a};`,"m-y":`margin-top: ${a}; margin-bottom: ${a};`,g:`gap: ${a};`,"g-x":`column-gap: ${a};`,"g-y":`row-gap: ${a};`,w:`width: ${a};`,h:`height: ${a};`,"min-w":`min-width: ${a};`,"max-w":`max-width: ${a};`,"min-h":`min-height: ${a};`,"max-h":`max-height: ${a};`}[t]||""}function _e(r){let{property:t,value:e,isArbitrary:i}=r;if(M[t]||M[t])return M[t];let u={bg:()=>`background-color: ${i?e:`var(--c-${e})`};`,text:()=>["left","center","right","justify"].includes(e)?`text-align: ${e};`:`color: ${i?e:`var(--c-${e})`};`,"text-size":()=>{let a,l;if(i)return a=e,`font-size: ${a};`;if(e.startsWith("tw-")){let m=e.slice(3);a=`var(--tw-text-${m})`,l=`var(--tw-leading-${m})`}else a=`var(--font-${e})`,l=`var(--font-lh-${e})`;return`font-size: ${a}; line-height: ${l};`},font:()=>{let a={sans:"ui-sans-serif, system-ui, sans-serif",serif:"ui-serif, Georgia, serif",mono:"ui-monospace, monospace"};if(a[e])return`font-family: ${a[e]};`;let l;return i?l=e:e.startsWith("tw-")?l=`var(--tw-font-${e.slice(3)})`:l=`var(--fw-${e})`,`font-weight: ${l};`},tracking:()=>`letter-spacing: ${i?e:{tighter:"-0.05em",tight:"-0.025em",normal:"0",wide:"0.025em",wider:"0.05em",widest:"0.1em"}[e]||e};`,leading:()=>`line-height: ${i?e:{none:"1",tight:"1.25",snug:"1.375",normal:"1.5",relaxed:"1.625",loose:"2"}[e]||e};`,"line-clamp":()=>`overflow: hidden; display: -webkit-box; -webkit-box-orient: vertical; -webkit-line-clamp: ${e};`,decoration:()=>`text-decoration-color: ${i?e:`var(--c-${e})`};`,"decoration-thickness":()=>`text-decoration-thickness: ${i?e:`${e}px`};`,"underline-offset":()=>`text-underline-offset: ${i?e:`${e}px`};`,indent:()=>`text-indent: ${i?e:`var(--s-${e})`};`,border:()=>`border-color: ${i?e:`var(--c-${e})`}; border-style: solid;`,"border-t":()=>`border-top-color: ${i?e:`var(--c-${e})`}; border-top-style: solid;`,"border-b":()=>`border-bottom-color: ${i?e:`var(--c-${e})`}; border-bottom-style: solid;`,"border-l":()=>`border-left-color: ${i?e:`var(--c-${e})`}; border-left-style: solid;`,"border-r":()=>`border-right-color: ${i?e:`var(--c-${e})`}; border-right-style: solid;`,"border-x":()=>{let a=i?e:`var(--c-${e})`;return`border-left-color: ${a}; border-right-color: ${a}; border-left-style: solid; border-right-style: solid;`},"border-y":()=>{let a=i?e:`var(--c-${e})`;return`border-top-color: ${a}; border-bottom-color: ${a}; border-top-style: solid; border-bottom-style: solid;`},"border-w":()=>`border-width: ${i?e:`var(--s-${e})`}; border-style: solid;`,"border-t-w":()=>`border-top-width: ${i?e:`var(--s-${e})`}; border-top-style: solid;`,"border-b-w":()=>`border-bottom-width: ${i?e:`var(--s-${e})`}; border-bottom-style: solid;`,"border-l-w":()=>`border-left-width: ${i?e:`var(--s-${e})`}; border-left-style: solid;`,"border-r-w":()=>`border-right-width: ${i?e:`var(--s-${e})`}; border-right-style: solid;`,"border-x-w":()=>{let a=i?e:`var(--s-${e})`;return`border-left-width: ${a}; border-right-width: ${a}; border-left-style: solid; border-right-style: solid;`},"border-y-w":()=>{let a=i?e:`var(--s-${e})`;return`border-top-width: ${a}; border-bottom-width: ${a}; border-top-style: solid; border-bottom-style: solid;`},rounded:()=>{let a;return i?a=e:e.startsWith("tw-")?a=`var(--tw-rounded-${e.slice(3)})`:a=`var(--r-${e})`,`border-radius: ${a};`},shadow:()=>{let a;return i?a=e:e.startsWith("tw-")?a=`var(--tw-shadow-${e.slice(3)})`:a=`var(--shadow-${e})`,`box-shadow: ${a};`},opacity:()=>`opacity: ${i?e:parseFloat(e)/100};`,content:()=>`content: "${e}";`,scale:()=>`transform: scale(${i?e:parseFloat(e)/100});`,"scale-x":()=>`transform: scaleX(${i?e:parseFloat(e)/100});`,"scale-y":()=>`transform: scaleY(${i?e:parseFloat(e)/100});`,rotate:()=>`transform: rotate(${i?e:`${e}deg`});`,"translate-x":()=>`transform: translateX(${i?e:{0:"0",full:"100%","1/2":"50%","-full":"-100%","-1/2":"-50%"}[e]||`var(--s-${e})`});`,"translate-y":()=>`transform: translateY(${i?e:{0:"0",full:"100%","1/2":"50%","-full":"-100%","-1/2":"-50%"}[e]||`var(--s-${e})`});`,"skew-x":()=>`transform: skewX(${i?e:`${e}deg`});`,"skew-y":()=>`transform: skewY(${i?e:`${e}deg`});`,origin:()=>`transform-origin: ${i?e.replace(/_/g," "):{center:"center",top:"top","top-right":"top right",right:"right","bottom-right":"bottom right",bottom:"bottom","bottom-left":"bottom left",left:"left","top-left":"top left"}[e]||e};`,transition:()=>({none:"transition-property: none;",all:"transition-property: all; transition-timing-function: cubic-bezier(0.4, 0, 0.2, 1); transition-duration: 150ms;",colors:"transition-property: color, background-color, border-color; transition-timing-function: cubic-bezier(0.4, 0, 0.2, 1); transition-duration: 150ms;",opacity:"transition-property: opacity; transition-timing-function: cubic-bezier(0.4, 0, 0.2, 1); transition-duration: 150ms;",shadow:"transition-property: box-shadow; transition-timing-function: cubic-bezier(0.4, 0, 0.2, 1); transition-duration: 150ms;",transform:"transition-property: transform; transition-timing-function: cubic-bezier(0.4, 0, 0.2, 1); transition-duration: 150ms;"})[e]||`transition-property: ${e};`,duration:()=>`transition-duration: ${i?e:{instant:"75ms",quick:"100ms",fast:"150ms",normal:"200ms",slow:"300ms",slower:"500ms",lazy:"700ms"}[e]||`${e}ms`};`,ease:()=>`transition-timing-function: ${{linear:"linear",in:"cubic-bezier(0.4, 0, 1, 1)",out:"cubic-bezier(0, 0, 0.2, 1)","in-out":"cubic-bezier(0.4, 0, 0.2, 1)"}[e]||e};`,delay:()=>`transition-delay: ${i?e:{instant:"75ms",quick:"100ms",fast:"150ms",normal:"200ms",slow:"300ms"}[e]||`${e}ms`};`,animate:()=>({none:"animation: none;",spin:"animation: spin 1s linear infinite;",ping:"animation: ping 1s cubic-bezier(0, 0, 0.2, 1) infinite;",pulse:"animation: pulse 2s cubic-bezier(0.4, 0, 0.6, 1) infinite;",bounce:"animation: bounce 1s infinite;"})[e]||`animation: ${e};`,blur:()=>`filter: blur(${i?e:{none:"0",sm:"4px",md:"8px",lg:"12px",xl:"16px","2xl":"24px","3xl":"40px"}[e]||`${e}px`});`,brightness:()=>`filter: brightness(${i?e:{0:"0",50:"0.5",75:"0.75",90:"0.9",95:"0.95",100:"1",105:"1.05",110:"1.1",125:"1.25",150:"1.5",200:"2"}[e]||parseFloat(e)/100});`,contrast:()=>`filter: contrast(${i?e:{0:"0",50:"0.5",75:"0.75",100:"1",125:"1.25",150:"1.5",200:"2"}[e]||parseFloat(e)/100});`,grayscale:()=>`filter: grayscale(${i?e:{0:"0",100:"1",full:"1"}[e]||parseFloat(e)/100});`,"hue-rotate":()=>`filter: hue-rotate(${i?e:`${e}deg`});`,invert:()=>`filter: invert(${i?e:{0:"0",100:"1",full:"1"}[e]||parseFloat(e)/100});`,saturate:()=>`filter: saturate(${i?e:{0:"0",50:"0.5",100:"1",150:"1.5",200:"2"}[e]||parseFloat(e)/100});`,sepia:()=>`filter: sepia(${i?e:{0:"0",100:"1",full:"1"}[e]||parseFloat(e)/100});`,"drop-shadow":()=>{let a={sm:"drop-shadow(0 1px 1px rgb(0 0 0 / 0.05))",md:"drop-shadow(0 4px 3px rgb(0 0 0 / 0.07)) drop-shadow(0 2px 2px rgb(0 0 0 / 0.06))",lg:"drop-shadow(0 10px 8px rgb(0 0 0 / 0.04)) drop-shadow(0 4px 3px rgb(0 0 0 / 0.1))",xl:"drop-shadow(0 20px 13px rgb(0 0 0 / 0.03)) drop-shadow(0 8px 5px rgb(0 0 0 / 0.08))","2xl":"drop-shadow(0 25px 25px rgb(0 0 0 / 0.15))",none:"drop-shadow(0 0 #0000)"};return`filter: ${i?`drop-shadow(${e.replace(/_/g," ")})`:a[e]||a.md};`},"bg-size":()=>`background-size: ${i?e.replace(/_/g," "):{auto:"auto",cover:"cover",contain:"contain"}[e]||e};`,"bg-pos":()=>`background-position: ${i?e.replace(/_/g," "):{center:"center",top:"top","top-right":"top right",right:"right","bottom-right":"bottom right",bottom:"bottom","bottom-left":"bottom left",left:"left","top-left":"top left"}[e]||e};`,"bg-repeat":()=>`background-repeat: ${{repeat:"repeat","no-repeat":"no-repeat","repeat-x":"repeat-x","repeat-y":"repeat-y",round:"round",space:"space"}[e]||e};`,"bg-attachment":()=>`background-attachment: ${e};`,"bg-clip":()=>`background-clip: ${{border:"border-box",padding:"padding-box",content:"content-box",text:"text"}[e]||e};`,"bg-origin":()=>`background-origin: ${{border:"border-box",padding:"padding-box",content:"content-box"}[e]||e};`,"bg-blend":()=>`background-blend-mode: ${e};`,"bg-image":()=>`background-image: ${i?e.replace(/_/g," "):{none:"none","gradient-to-t":"linear-gradient(to top, var(--tw-gradient-stops))","gradient-to-tr":"linear-gradient(to top right, var(--tw-gradient-stops))","gradient-to-r":"linear-gradient(to right, var(--tw-gradient-stops))","gradient-to-br":"linear-gradient(to bottom right, var(--tw-gradient-stops))","gradient-to-b":"linear-gradient(to bottom, var(--tw-gradient-stops))","gradient-to-bl":"linear-gradient(to bottom left, var(--tw-gradient-stops))","gradient-to-l":"linear-gradient(to left, var(--tw-gradient-stops))","gradient-to-tl":"linear-gradient(to top left, var(--tw-gradient-stops))"}[e]||e};`,from:()=>`--tw-gradient-from: ${i?e:`var(--c-${e})`}; --tw-gradient-to: transparent; --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,via:()=>`--tw-gradient-via: ${i?e:`var(--c-${e})`}; --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-via), var(--tw-gradient-to);`,to:()=>`--tw-gradient-to: ${i?e:`var(--c-${e})`};`,"backdrop-blur":()=>`backdrop-filter: blur(${i?e:{none:"0",sm:"4px",md:"8px",lg:"12px",xl:"16px","2xl":"24px","3xl":"40px"}[e]||`${e}px`});`,"backdrop-brightness":()=>`backdrop-filter: brightness(${i?e:parseFloat(e)/100});`,"backdrop-contrast":()=>`backdrop-filter: contrast(${i?e:parseFloat(e)/100});`,"backdrop-grayscale":()=>`backdrop-filter: grayscale(${i?e:{0:"0",100:"1",full:"1"}[e]||parseFloat(e)/100});`,"backdrop-hue-rotate":()=>`backdrop-filter: hue-rotate(${i?e:`${e}deg`});`,"backdrop-invert":()=>`backdrop-filter: invert(${i?e:{0:"0",100:"1",full:"1"}[e]||parseFloat(e)/100});`,"backdrop-opacity":()=>`backdrop-filter: opacity(${i?e:parseFloat(e)/100});`,"backdrop-saturate":()=>`backdrop-filter: saturate(${i?e:parseFloat(e)/100});`,"backdrop-sepia":()=>`backdrop-filter: sepia(${i?e:{0:"0",100:"1",full:"1"}[e]||parseFloat(e)/100});`,"animation-duration":()=>`animation-duration: ${i?e:{instant:"75ms",quick:"100ms",fast:"150ms",normal:"200ms",slow:"300ms",slower:"500ms",lazy:"700ms"}[e]||`${e}ms`};`,"animation-delay":()=>`animation-delay: ${i?e:{instant:"75ms",quick:"100ms",fast:"150ms",normal:"200ms",slow:"300ms"}[e]||`${e}ms`};`,"animation-iteration":()=>`animation-iteration-count: ${{infinite:"infinite",once:"1",twice:"2"}[e]||e};`,"animation-direction":()=>`animation-direction: ${e};`,"animation-fill":()=>`animation-fill-mode: ${e};`,"animation-play":()=>`animation-play-state: ${e};`,"animation-timing":()=>`animation-timing-function: ${{linear:"linear",in:"cubic-bezier(0.4, 0, 1, 1)",out:"cubic-bezier(0, 0, 0.2, 1)","in-out":"cubic-bezier(0.4, 0, 0.2, 1)"}[e]||e};`,"scroll-behavior":()=>`scroll-behavior: ${e};`,"scroll-m":()=>`scroll-margin: ${i?e:`var(--s-${e})`};`,"scroll-m-x":()=>{let a=i?e:`var(--s-${e})`;return`scroll-margin-left: ${a}; scroll-margin-right: ${a};`},"scroll-m-y":()=>{let a=i?e:`var(--s-${e})`;return`scroll-margin-top: ${a}; scroll-margin-bottom: ${a};`},"scroll-p":()=>`scroll-padding: ${i?e:`var(--s-${e})`};`,"scroll-p-x":()=>{let a=i?e:`var(--s-${e})`;return`scroll-padding-left: ${a}; scroll-padding-right: ${a};`},"scroll-p-y":()=>{let a=i?e:`var(--s-${e})`;return`scroll-padding-top: ${a}; scroll-padding-bottom: ${a};`},"snap-align":()=>`scroll-snap-align: ${e};`,"snap-stop":()=>`scroll-snap-stop: ${e};`,"snap-type":()=>`scroll-snap-type: ${{none:"none",x:"x mandatory",y:"y mandatory",both:"both mandatory","x-proximity":"x proximity","y-proximity":"y proximity"}[e]||e};`,touch:()=>`touch-action: ${{auto:"auto",none:"none","pan-x":"pan-x","pan-y":"pan-y","pan-left":"pan-left","pan-right":"pan-right","pan-up":"pan-up","pan-down":"pan-down","pinch-zoom":"pinch-zoom",manipulation:"manipulation"}[e]||e};`,resize:()=>`resize: ${{none:"none",both:"both",x:"horizontal",y:"vertical"}[e]||e};`,"will-change":()=>`will-change: ${{auto:"auto",scroll:"scroll-position",contents:"contents",transform:"transform",opacity:"opacity"}[e]||e};`,"color-scheme":()=>`color-scheme: ${e};`,"field-sizing":()=>`field-sizing: ${e};`,"forced-color":()=>`forced-color-adjust: ${e};`,"border-style":()=>`border-style: ${e};`,outline:()=>`outline-color: ${i?e:`var(--c-${e})`};`,"outline-style":()=>`outline-style: ${e};`,"outline-w":()=>`outline-width: ${i?e:`${e}px`};`,"outline-offset":()=>`outline-offset: ${i?e:`${e}px`};`,ring:()=>e==="none"?"box-shadow: 0 0 0 0 transparent;":`box-shadow: 0 0 0 var(--ring-offset) var(--ring-offset-color), 0 0 0 calc(${i?e:`var(--ring-${e})`} + var(--ring-offset)) var(--ring-color);`,"ring-color":()=>`--ring-color: ${i?e:`var(--c-${e})`};`,"ring-offset":()=>`--ring-offset: ${i?e:`${e}px`};`,"ring-offset-color":()=>`--ring-offset-color ${i?e:`var(--c-${e})`};`,divide:()=>`border-color: ${i?e:`var(--c-${e})`}; border-style: solid;`,"divide-x":()=>{if(e==="reverse")return"--ss-divide-x-reverse: 1;";let a=i?e:`var(--c-${e})`;return`border-left-color: ${a}; border-right-color: ${a}; border-left-style: solid; border-right-style: solid;`},"divide-y":()=>{if(e==="reverse")return"--ss-divide-y-reverse: 1;";let a=i?e:`var(--c-${e})`;return`border-top-color: ${a}; border-bottom-color: ${a}; border-top-style: solid; border-bottom-style: solid;`},"divide-w":()=>`border-width: ${i?e:`var(--s-${e})`}; border-style: solid;`,"divide-x-w":()=>{let a=i?e:`var(--s-${e})`;return`
        ...
        `},"divide-x:reverse":()=>"--ss-divide-x-reverse: 1;","divide-y:reverse":()=>"--ss-divide-y-reverse: 1;","divide-style":()=>`border-style: ${e};`,stroke:()=>`stroke: ${i?e:`var(--c-${e})`};`,"stroke-w":()=>`stroke-width: ${e};`,fill:()=>e==="none"?"fill: none;":`fill: ${i?e:`var(--c-${e})`};`,"mix-blend":()=>`mix-blend-mode: ${e};`,perspective:()=>`perspective: ${i?e:{none:"none",sm:"500px",md:"1000px",lg:"1500px",xl:"2000px"}[e]||e};`,"perspective-origin":()=>`perspective-origin: ${i?e.replace(/_/g," "):{center:"center",top:"top","top-right":"top right",right:"right","bottom-right":"bottom right",bottom:"bottom","bottom-left":"bottom left",left:"left","top-left":"top left"}[e]||e};`,"rotate-x":()=>`transform: rotateX(${i?e:`${e}deg`});`,"rotate-y":()=>`transform: rotateY(${i?e:`${e}deg`});`,"rotate-z":()=>`transform: rotateZ(${i?e:`${e}deg`});`,"transform-style":()=>`transform-style: ${e};`,backface:()=>`backface-visibility: ${{visible:"visible",hidden:"hidden"}[e]||e};`}[t];return u?u():""}function S(r,t){if(t==="layout"&&y[r])return`[layout~="${r}"] { ${y[r]} }
`;let e=A(r,t),i="";switch(t){case"layout":i=Ye(e);break;case"space":i=Ze(e);break;case"visual":i=_e(e);break}if(!i)return"";let o=r.startsWith("divide")&&!r.includes(":reverse"),u="";return o?u=`[visual~="${r}"] > :not([hidden]) ~ :not([hidden])`:u=`[${t}~="${r}"]`,e.state&&e.state!=="dark"&&(o?u=`[visual~="${r}"] > :not([hidden]) ~ :not([hidden]):${e.state}`:u+=`:${e.state}`),`${u} { ${i} }
`}function D(){let r={layout:new Set,space:new Set,visual:new Set};return document.querySelectorAll("[layout], [space], [visual]").forEach(e=>{["layout","space","visual"].forEach(i=>{let o=e.getAttribute(i);o&&o.split(/\s+/).forEach(u=>{u&&r[i].add(u)})})}),r}function z(r,t){let e=x(t);t.preflight!==!1&&(e+=P());let i=[];for(let[s,c]of Object.entries(r))for(let f of c)i.push({raw:f,attrType:s});let o=[],u=[],a={},{screens:l}=t.theme;for(let s of Object.keys(l))a[s]=[];for(let s of i){let c=A(s.raw,s.attrType);c.state==="dark"?u.push(c):c.breakpoint?(a[c.breakpoint]||(a[c.breakpoint]=[]),a[c.breakpoint].push(c)):o.push(c)}let m=["flex","grid","inline-flex","inline-grid","block","inline","hidden","contents"],d=new Map;for(let s of o)s.attrType&&m.includes(s.property)&&(d.has(s.attrType)||d.set(s.attrType,new Set),d.get(s.attrType).add(s.raw));for(let s of o)e+=S(s.raw,s.attrType);for(let[s,c]of Object.entries(a))if(c.length>0){e+=`
@media (min-width: ${l[s]}) {
`;let f=new Set;for(let g of c)if(g.attrType&&m.includes(g.property)&&d.has(g.attrType)){let $=d.get(g.attrType);if($.size>0&&!$.has(g.raw)&&!f.has(g.raw)){let Qe=`[${g.attrType}~="${g.raw}"]`;e+=`  ${Qe} { display: revert-layer; }
`,f.add(g.raw)}}for(let g of c)e+="  "+S(g.raw,g.attrType);e+=`}
`}if(u.length>0){let s=t.darkMode||"media";if(s==="media"){e+=`
@media (prefers-color-scheme: dark) {
`;for(let c of u)e+="  "+S(c.raw,c.attrType);e+=`}
`}else{let c=Array.isArray(s)?s[1]:".dark";e+=`
/* Dark Mode */
`;for(let f of u){let g=S(f.raw,f.attrType);e+=g.replace(/^(\[[^\]]+\])/,`${c} $1`)}}}return e}function j(r){let t=document.getElementById("senangstart-jit");t||(t=document.createElement("style"),t.id="senangstart-jit",document.head.appendChild(t)),t.textContent=r}function B(){let r=b(),t=h(r),e=D(),i=z(e,t);j(i),new MutationObserver(()=>{let u=D(),a=z(u,t);j(a)}).observe(document.body,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["layout","space","visual"]}),console.log("%c[SenangStart CSS]%c Just-in-Time runtime initialized \u2713","color: #2563EB; font-weight: bold;","color: #10B981;")}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",B):B()})();})();
