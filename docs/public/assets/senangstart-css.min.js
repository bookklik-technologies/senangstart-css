...
(()=>{var x=["mob","tab","lap","desk","tw-sm","tw-md","tw-lg","tw-xl","tw-2xl"],f=["hover","focus","focus-visible","active","disabled","dark","expanded","selected"],V=["flex","grid","block","inline","hidden","row","col","row-reverse","col-reverse","center","start","end","between","around","evenly","wrap","nowrap","absolute","relative","fixed","sticky","hoverable","focusable","pressable","expandable","selectable","disabled"];function b(r){if(typeof r!="string")return"";let l=/[;]/g;return l.test(r)?r.replace(l,"_"):r}function qe(r){return!(!r.property||typeof r.property!="string"||r.property.length>100||r.value!==null&&typeof r.value!="string"||r.value&&r.value.length>500||r.breakpoint&&!x.includes(r.breakpoint)||r.state&&!f.includes(r.state))}function Ye(r,l){if(typeof r!="string"||r.length===0||r.length>200)return{raw:r,breakpoint:null,state:null,property:null,value:null,isArbitrary:!1,attrType:l,error:"Invalid token format"};let t={raw:r,breakpoint:null,state:null,property:null,value:null,isArbitrary:!1,attrType:l};if(l==="layout"){if(r.startsWith("z:"))return t.property="z",t.value=r.substring(2),t;if(r.startsWith("overflow:"))return t.property="overflow",t.value=r.substring(9),t;if(V.includes(r))return t.property=r,t.value=r,t;let d=r.split(":");if(d.length===2&&x.includes(d[0]))return t.breakpoint=d[0],t.property=d[1],t.value=d[1],t}let e=r.split(":");if(e.length===1)return t.property=r,t.value=r,t;let i=0;if(x.includes(e[0])&&(t.breakpoint=e[0],i++),f.includes(e[i])&&(t.state=e[i],i++),i<e.length&&(t.property=e[i],i++),i<e.length){let d=e.slice(i).join(":"),u=d.match(/^\[(.+)\]$/);u?(t.value=b(u[1].replace(/_/g," ")),t.isArbitrary=!0):t.value=b(d)}return qe(t)||(t.error="Invalid token structure"),t}function C(r){let l=[];for(let[t,e]of Object.entries(r))for(let i of e)l.push(Ye(i,t));return l}function T(r){return`/* 
...
`}var D={name:"display",property:"layout",syntax:'layout="[display-value]"',description:"Control the display type of elements",descriptionMs:"Kawal jenis paparan elemen",category:"layout",values:[{value:"flex",css:"display: flex;",description:"Flexbox container",descriptionMs:"Bekas flexbox"},{value:"inline-flex",css:"display: inline-flex;",description:"Inline flexbox container",descriptionMs:"Bekas flexbox sebaris"},{value:"grid",css:"display: grid;",description:"Grid container",descriptionMs:"Bekas grid"},{value:"inline-grid",css:"display: inline-grid;",description:"Inline grid container",descriptionMs:"Bekas grid sebaris"},{value:"block",css:"display: block;",description:"Block element",descriptionMs:"Elemen blok"},{value:"inline",css:"display: inline-block;",description:"Inline block element",descriptionMs:"Elemen blok sebaris"},{value:"hidden",css:"display: none;",description:"Hidden element",descriptionMs:"Elemen tersembunyi"}],examples:[{code:'<div layout="flex">Flexbox container</div>',description:"Create a flex container"},{code:'<div layout="grid">Grid container</div>',description:"Create a grid container"},{code:'<div layout="hidden">Hidden element</div>',description:"Hide an element"}],preview:[{title:"Flexbox Container",titleMs:"Bekas Flexbox",description:"Items arranged horizontally",descriptionMs:"Item disusun secara mendatar",html:`<div layout="flex row" space="g:small p:medium" visual="bg:neutral-100 dark:bg:neutral-900 rounded:medium">
...
</div>`,highlightValue:"flex:auto"}]},E={name:"flex-basis",property:"layout",syntax:'layout="basis:[value]"',description:"Set initial size of flex item",descriptionMs:"Tetapkan saiz awal item flex",category:"layout",usesScale:"spacing",supportsArbitrary:!0,dynamic:!0,values:[{value:"auto",css:"flex-basis: auto;",description:"Auto basis",descriptionMs:"Asas automatik"},{value:"0",css:"flex-basis: 0;",description:"Zero basis",descriptionMs:"Asas sifar"}],examples:[{code:'<div layout="basis:[200px]">200px basis</div>',description:"Fixed basis"}],preview:[{title:"Fixed Basis",titleMs:"Asas Tetap",description:"Items with different basis sizes",descriptionMs:"Item dengan saiz asas berbeza",html:`<div layout="flex" space="g:small p:medium" visual="bg:neutral-100 dark:bg:neutral-900 rounded:medium">
...
</div>`,highlightValue:"basis:[100px]"}]},P={name:"order",property:"layout",syntax:'layout="order:[value]"',description:"Control flex/grid item order",descriptionMs:"Kawal susunan item flex/grid",category:"layout",dynamic:!0,values:[{value:"first",css:"order: -9999;",description:"Move to first",descriptionMs:"Pindah ke pertama"},{value:"last",css:"order: 9999;",description:"Move to last",descriptionMs:"Pindah ke terakhir"},{value:"none",css:"order: 0;",description:"Default order",descriptionMs:"Susunan lalai"},{value:"1-12",css:"order: {n};",description:"Specific order",descriptionMs:"Susunan tertentu"}],examples:[{code:'<div layout="order:first">First item</div>',description:"Move to first"}],preview:[{title:"Reorder Items",titleMs:"Susun Semula Item",description:"Change visual order of flex items",descriptionMs:"Ubah susunan visual item flex",html:`<div layout="flex" space="g:small p:medium" visual="bg:neutral-100 dark:bg:neutral-900 rounded:medium">
  ...
  <span space="p:small" visual="bg:primary text:white rounded:small" layout="text:center">3</span>
  <span space="p:small" visual="bg:primary text:white rounded:small" layout="text:center">4</span>
</div>`,highlightValue:"grid-flow:col"}]},_={name:"grid-auto-sizing",property:"layout",syntax:'layout="auto-cols:[value]" or layout="auto-rows:[value]"',description:"Control size of auto-generated grid tracks",descriptionMs:"Kawal saiz trek grid yang dijana automatik",category:"layout",dynamic:!0,values:[{value:"auto",css:"auto",description:"Auto size",descriptionMs:"Saiz automatik"},{value:"min",css:"min-content",description:"Minimum content",descriptionMs:"Kandungan minimum"},{value:"max",css:"max-content",description:"Maximum content",descriptionMs:"Kandungan maksimum"},{value:"fr",css:"minmax(0, 1fr)",description:"Fractional unit",descriptionMs:"Unit pecahan"}],examples:[{code:'<div layout="grid auto-cols:min">Auto min columns</div>',description:"Min-content columns"}],preview:[{title:"Auto Columns",titleMs:"Lajur Automatik",description:"Automatically sized column tracks",descriptionMs:"Trek lajur bersaiz automatik",html:`<div layout="grid grid-flow:col auto-cols:fr" space="g:small p:medium" visual="bg:neutral-100 dark:bg:neutral-900 rounded:medium">
...
</div>`,highlightValue:"mix-blend:multiply"}]},Ma={name:"accent-color",property:"visual",syntax:'visual="accent:[color]"',description:"Set accent color for form controls",descriptionMs:"Tetapkan warna aksen untuk kawalan borang",category:"visual",usesScale:"colors",supportsArbitrary:!0,values:[],examples:[{code:'<input type="checkbox" visual="accent:primary">',description:"Primary accent"}],preview:[{title:"Accent Color",titleMs:"Warna Aksen",description:"Style native form controls (checkboxes, radios, range)",descriptionMs:"Gaya kawalan borang asli (kotak semak, radio, julat)",html:`<div layout="flex" space="g:medium p:medium" visual="bg:neutral-100 dark:bg:neutral-900 rounded:medium">
...
</div>`,highlightValue:"from:blue-500"}]},Ja={name:"gradient-via",property:"visual",syntax:'visual="via:[color]"',description:"Set gradient middle color",descriptionMs:"Tetapkan warna tengah gradien",category:"visual",usesScale:"colors",supportsArbitrary:!0,values:[{value:"purple-500",css:"--tw-gradient-via: var(--c-purple-500); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-via), var(--tw-gradient-to);",description:"Via purple",descriptionMs:"Melalui ungu"}],examples:[{code:'<div visual="bg-image:gradient-to-r from:blue-500 via:purple-500 to:pink-500">Three-color gradient</div>',description:"Three-color gradient"}],preview:[{title:"Gradient Via",titleMs:"Pertengahan Gradien",description:"Add a middle color stop to gradients",descriptionMs:"Tambah hentian warna tengah pada gradien",html:`<div layout="flex" space="g:medium p:medium" visual="bg:neutral-100 dark:bg:neutral-900 rounded:medium">
...
</div>`,highlightValue:"to:purple-500"}]},we={backgroundImage:Fa,backgroundAttachment:Va,backgroundClip:Ca,backgroundOrigin:Ta,backgroundPosition:Da,backgroundRepeat:za,backgroundSize:$a,backgroundBlendMode:ja,gradientFrom:Oa,gradientVia:Ja,gradientTo:Ha,backdropBlur:Ba,backdropBrightness:Ea,backdropContrast:Pa,backdropGrayscale:Ka,backdropHueRotate:Ra,backdropInvert:Ia,backdropOpacity:La,backdropSaturate:Na,backdropSepia:Ga},Me=we;var Wa={name:"scroll-behavior",property:"visual",syntax:'visual="scroll-behavior:[value]"',description:"Set scroll behavior",descriptionMs:"Tetapkan kelakuan skrol",category:"visual",values:[{value:"auto",css:"scroll-behavior: auto;",description:"Instant scroll",descriptionMs:"Skrol serta-merta"},{value:"smooth",css:"scroll-behavior: smooth;",description:"Smooth scroll",descriptionMs:"Skrol lancar"}],examples:[{code:'<html visual="scroll-behavior:smooth">Smooth scrolling</html>',description:"Smooth scroll"}],preview:[{title:"Scroll Behavior",titleMs:"Kelakuan Skrol",description:"Smooth or instant scrolling",descriptionMs:"Skrol lancar atau serta-merta",html:`<div layout="flex" space="g:medium p:medium" visual="bg:neutral-100 dark:bg:neutral-900 rounded:medium">
  <div space="p:small" visual="bg:primary text:white rounded:small">auto</div>
...
</div>`,highlightValue:"snap-align:start"}]},Ya={name:"scroll-snap-stop",property:"visual",syntax:'visual="snap-stop:[value]"',description:"Control scroll snap stop behavior",descriptionMs:"Kawal kelakuan hentian snap skrol",category:"visual",values:[{value:"normal",css:"scroll-snap-stop: normal;",description:"Normal stop",descriptionMs:"Hentian biasa"},{value:"always",css:"scroll-snap-stop: always;",description:"Always stop",descriptionMs:"Sentiasa berhenti"}],examples:[{code:'<div visual="snap-stop:always">Always stop here</div>',description:"Force stop"}],preview:[{title:"Snap Stop",titleMs:"Hentian Snap",description:"Control whether to stop at snap point",descriptionMs:"Kawal sama ada berhenti di titik snap",html:`<div layout="flex" space="g:medium p:medium" visual="bg:neutral-100 dark:bg:neutral-900 rounded:medium">
  <div space="p:small" visual="bg:primary text:white rounded:small">normal</div>
...
</div>`,highlightValue:"break-words"}]},ui={name:"hyphens",property:"visual",syntax:'visual="hyphens:[value]"',description:"Control hyphenation",descriptionMs:"Kawal tanda sempang",category:"visual",values:[{value:"none",css:"hyphens: none;",description:"No hyphens",descriptionMs:"Tiada sempang"},{value:"manual",css:"hyphens: manual;",description:"Manual hyphens",descriptionMs:"Sempang manual"},{value:"auto",css:"hyphens: auto;",description:"Auto hyphens",descriptionMs:"Sempang automatik"}],examples:[{code:'<p visual="hyphens:auto">Automatic hyphenation</p>',description:"Auto hyphens"}],preview:[{title:"Hyphens",titleMs:"Sempang",description:"Control automatic hyphenation",descriptionMs:"Kawal sempang automatik",html:`<div layout="flex" space="g:medium p:medium" visual="bg:neutral-100 dark:bg:neutral-900 rounded:medium">
...
</div>`,highlightValue:"italic"}]},gi={name:"font-smoothing",property:"visual",syntax:'visual="[smoothing-value]"',description:"Control font smoothing",descriptionMs:"Kawal penghalusan fon",category:"visual",values:[{value:"antialiased",css:"-webkit-font-smoothing: antialiased; -moz-osx-font-smoothing: grayscale;",description:"Antialiased",descriptionMs:"Antialias"},{value:"subpixel-antialiased",css:"-webkit-font-smoothing: auto; -moz-osx-font-smoothing: auto;",description:"Subpixel antialiased",descriptionMs:"Subpixel antialias"}],examples:[{code:'<body visual="antialiased">Smooth fonts</body>',description:"Antialiased text"}],preview:[{title:"Font Smoothing",titleMs:"Penghalusan Fon",description:"Control text rendering",descriptionMs:"Kawal persembahan teks",html:`<div layout="flex" space="g:medium p:medium" visual="bg:neutral-100 dark:bg:neutral-900 rounded:medium">
...
</div>`,highlightValue:"grayscale:full"}]},zi={name:"filter-hue-rotate",property:"visual",syntax:'visual="hue-rotate:[degrees]"',description:"Rotate hue colors",descriptionMs:"Putar warna rona",category:"visual",supportsArbitrary:!0,dynamic:!0,values:[{value:"0",css:"filter: hue-rotate(0deg);",description:"No rotation",descriptionMs:"Tiada putaran"},{value:"90",css:"filter: hue-rotate(90deg);",description:"90\xB0 rotation",descriptionMs:"Putaran 90\xB0"},{value:"180",css:"filter: hue-rotate(180deg);",description:"180\xB0 rotation",descriptionMs:"Putaran 180\xB0"}],examples:[{code:'<img visual="hue-rotate:90">Shifted hue</img>',description:"Rotate hue 90 degrees"}],preview:[{title:"Hue Rotate Filter",titleMs:"Penapis Putaran Rona",description:"Rotate color hues",descriptionMs:"Putar rona warna",html:`<div layout="flex" space="g:medium p:medium" visual="bg:neutral-100 dark:bg:neutral-900 rounded:medium">
  <div space="p:small" visual="bg:primary text:white rounded:small">0\xB0</div>
...
`;let e=[],i=[],d={},{screens:u}=l.theme;for(let n of Object.keys(u))d[n]=[];for(let n of r)n.state==="dark"?i.push(n):n.breakpoint?(d[n.breakpoint]||(d[n.breakpoint]=[]),d[n.breakpoint].push(n)):e.push(n);let a=new Set;for(let n of r)n.attrType==="interact"&&a.add(n.raw);let s=["flex","grid","inline-flex","inline-grid","block","inline","hidden","contents"],o=new Map;for(let n of e)n.attrType&&s.includes(n.property)&&(o.has(n.attrType)||o.set(n.attrType,new Set),o.get(n.attrType).add(n.raw));for(let n of e)t+=y(n,l,!1,a);for(let[n,p]of Object.entries(d))if(p.length>0){t+=`
@media (min-width: ${u[n]}) {
`;let c=new Set;for(let m of p)if(m.attrType&&s.includes(m.property)&&o.has(m.attrType)){let v=o.get(m.attrType);if(v.size>0&&!v.has(m.raw)&&!c.has(m.raw)){let g=`[${m.attrType}~="${m.raw}"]`;t+=`  ${g} { display: revert-layer; }
`,c.add(m.raw)}}for(let m of p)t+="  "+y(m,l,!1,a);t+=`}
`}if(i.length>0){let n=l.darkMode||"media",p=bt(l);if(n==="media"){t+=`
/* Dark Mode (prefers-color-scheme) */
`,t+=`@media (prefers-color-scheme: dark) {
`;for(let c of i)t+="  "+y(c,l,!0,a);t+=`}
`}else{t+=`
/* Dark Mode (${p}) */
`;for(let c of i){let v=y(c,l,!0,a).replace(/^(\[[^\]]+\])/,`${p} $1`);t+=v}}}return t}var ht={content:["./**/*.html","./src/**/*.{html,jsx,tsx,vue,svelte}","./pages/**/*.{html,jsx,tsx}","./components/**/*.{html,jsx,tsx}"],output:{css:"./public/senangstart.css",minify:!1,aiContext:"./.cursorrules",typescript:"./types/senang.d.ts"},darkMode:"media",preflight:!0,theme:{spacing:{none:"0px",thin:"1px",regular:"2px",thick:"3px",tiny:"4px","tiny-2x":"6px",small:"8px","small-2x":"10px","small-3x":"12px","small-4x":"14px",medium:"16px","medium-2x":"20px","medium-3x":"24px","medium-4x":"28px",large:"32px","large-2x":"36px","large-3x":"40px","large-4x":"44px",big:"48px","big-2x":"56px","big-3x":"64px","big-4x":"80px",giant:"96px","giant-2x":"112px","giant-3x":"128px","giant-4x":"144px",vast:"160px","vast-2x":"176px","vast-3x":"192px","vast-4x":"208px","vast-5x":"224px","vast-6x":"240px","vast-7x":"256px","vast-8x":"288px","vast-9x":"320px","vast-10x":"384px"},radius:{none:"0px",small:"4px",medium:"8px",big:"16px",round:"9999px"},shadow:{none:"none",small:"0 1px 2px rgba(0,0,0,0.05)",medium:"0 4px 6px rgba(0,0,0,0.1)",big:"0 10px 15px rgba(0,0,0,0.15)",giant:"0 25px 50px rgba(0,0,0,0.25)"},fontSize:{mini:"0.75rem",small:"0.875rem",base:"1rem",large:"1.125rem",big:"1.25rem",huge:"1.5rem",grand:"1.875rem",giant:"2.25rem",mount:"3rem",mega:"3.75rem",giga:"4.5rem",tera:"6rem",hero:"8rem"},fontSizeLineHeight:{mini:"1rem",small:"1.25rem",base:"1.5rem",large:"1.75rem",big:"1.75rem",huge:"2rem",grand:"2.25rem",giant:"2.5rem",mount:"1",mega:"1",giga:"1",tera:"1",hero:"1"},fontWeight:{normal:"400",medium:"500",bold:"700"},screens:{mob:"480px",tab:"768px",lap:"1024px",desk:"1280px","tw-sm":"640px","tw-md":"768px","tw-lg":"1024px","tw-xl":"1280px","tw-2xl":"1536px"},colors:{white:"#FFFFFF",black:"#000000",grey:"#6B7280",dark:"#3E4A5D",light:"#DBEAFE",primary:"#2563EB",secondary:"#DBEAFE",success:"#10B981",warning:"#F59E0B",danger:"#EF4444","red-50":"#FEF2F2","red-100":"#FEE2E2","red-200":"#FECACA","red-300":"#FCA5A5","red-400":"#F87171","red-500":"#EF4444","red-600":"#DC2626","red-700":"#B91C1C","red-800":"#991B1B","red-900":"#7F1D1D","red-950":"#450A0A","orange-50":"#FFF7ED","orange-100":"#FFEDD5","orange-200":"#FED7AA","orange-300":"#FDBA74","orange-400":"#FB923C","orange-500":"#F97316","orange-600":"#EA580C","orange-700":"#C2410C","orange-800":"#9A3412","orange-900":"#7C2D12","orange-950":"#431407","amber-50":"#FFFBEB","amber-100":"#FEF3C7","amber-200":"#FDE68A","amber-300":"#FCD34D","amber-400":"#FBBF24","amber-500":"#F59E0B","amber-600":"#D97706","amber-700":"#B45309","amber-800":"#92400E","amber-900":"#78350F","amber-950":"#451A03","yellow-50":"#FEFCE8","yellow-100":"#FEF9C3","yellow-200":"#FEF08A","yellow-300":"#FDE047","yellow-400":"#FACC15","yellow-500":"#EAB308","yellow-600":"#CA8A04","yellow-700":"#A16207","yellow-800":"#854D0E","yellow-900":"#713F12","yellow-950":"#422006","lime-50":"#F7FEE7","lime-100":"#ECFCCB","lime-200":"#D9F99D","lime-300":"#BEF264","lime-400":"#A3E635","lime-500":"#84CC16","lime-600":"#65A30D","lime-700":"#4D7C0F","lime-800":"#3F6212","lime-900":"#365314","lime-950":"#1A2E05","green-50":"#F0FDF4","green-100":"#DCFCE7","green-200":"#BBF7D0","green-300":"#86EFAC","green-400":"#4ADE80","green-500":"#22C55E","green-600":"#16A34A","green-700":"#15803D","green-800":"#166534","green-900":"#14532D","green-950":"#052E16","emerald-50":"#ECFDF5","emerald-100":"#D1FAE5","emerald-200":"#A7F3D0","emerald-300":"#6EE7B7","emerald-400":"#34D399","emerald-500":"#10B981","emerald-600":"#059669","emerald-700":"#047857","emerald-800":"#065F46","emerald-900":"#064E3B","emerald-950":"#022C22","teal-50":"#F0FDFA","teal-100":"#CCFBF1","teal-200":"#99F6E4","teal-300":"#5EEAD4","teal-400":"#2DD4BF","teal-500":"#14B8A6","teal-600":"#0D9488","teal-700":"#0F766E","teal-800":"#115E59","teal-900":"#134E4A","teal-950":"#042F2E","cyan-50":"#ECFEFF","cyan-100":"#CFFAFE","cyan-200":"#A5F3FC","cyan-300":"#67E8F9","cyan-400":"#22D3EE","cyan-500":"#06B6D4","cyan-600":"#0891B2","cyan-700":"#0E7490","cyan-800":"#155E75","cyan-900":"#164E63","cyan-950":"#083344","sky-50":"#F0F9FF","sky-100":"#E0F2FE","sky-200":"#BAE6FD","sky-300":"#7DD3FC","sky-400":"#38BDF8","sky-500":"#0EA5E9","sky-600":"#0284C7","sky-700":"#0369A1","sky-800":"#075985","sky-900":"#0C4A6E","sky-950":"#082F49","blue-50":"#EFF6FF","blue-100":"#DBEAFE","blue-200":"#BFDBFE","blue-300":"#93C5FD","blue-400":"#60A5FA","blue-500":"#3B82F6","blue-600":"#2563EB","blue-700":"#1D4ED8","blue-800":"#1E40AF","blue-900":"#1E3A8A","blue-950":"#172554","indigo-50":"#EEF2FF","indigo-100":"#E0E7FF","indigo-200":"#C7D2FE","indigo-300":"#A5B4FC","indigo-400":"#818CF8","indigo-500":"#6366F1","indigo-600":"#4F46E5","indigo-700":"#4338CA","indigo-800":"#3730A3","indigo-900":"#312E81","indigo-950":"#1E1B4B","violet-50":"#F5F3FF","violet-100":"#EDE9FE","violet-200":"#DDD6FE","violet-300":"#C4B5FD","violet-400":"#A78BFA","violet-500":"#8B5CF6","violet-600":"#7C3AED","violet-700":"#6D28D9","violet-800":"#5B21B6","violet-900":"#4C1D95","violet-950":"#2E1065","purple-50":"#FAF5FF","purple-100":"#F3E8FF","purple-200":"#E9D5FF","purple-300":"#D8B4FE","purple-400":"#C084FC","purple-500":"#A855F7","purple-600":"#9333EA","purple-700":"#7E22CE","purple-800":"#6B21A8","purple-900":"#581C87","purple-950":"#3B0764","fuchsia-50":"#FDF4FF","fuchsia-100":"#FAE8FF","fuchsia-200":"#F5D0FE","fuchsia-300":"#F0ABFC","fuchsia-400":"#E879F9","fuchsia-500":"#D946EF","fuchsia-600":"#C026D3","fuchsia-700":"#A21CAF","fuchsia-800":"#86198F","fuchsia-900":"#701A75","fuchsia-950":"#4A044E","pink-50":"#FDF2F8","pink-100":"#FCE7F3","pink-200":"#FBCFE8","pink-300":"#F9A8D4","pink-400":"#F472B6","pink-500":"#EC4899","pink-600":"#DB2777","pink-700":"#BE185D","pink-800":"#9D174D","pink-900":"#831843","pink-950":"#500724","rose-50":"#FFF1F2","rose-100":"#FFE4E6","rose-200":"#FECDD3","rose-300":"#FDA4AF","rose-400":"#FB7185","rose-500":"#F43F5E","rose-600":"#E11D48","rose-700":"#BE123C","rose-800":"#9F1239","rose-900":"#881337","rose-950":"#4C0519","slate-50":"#F8FAFC","slate-100":"#F1F5F9","slate-200":"#E2E8F0","slate-300":"#CBD5E1","slate-400":"#94A3B8","slate-500":"#64748B","slate-600":"#475569","slate-700":"#334155","slate-800":"#1E293B","slate-900":"#0F172A","slate-950":"#020617","gray-50":"#F9FAFB","gray-100":"#F3F4F6","gray-200":"#E5E7EB","gray-300":"#D1D5DB","gray-400":"#9CA3AF","gray-500":"#6B7280","gray-600":"#4B5563","gray-700":"#374151","gray-800":"#1F2937","gray-900":"#111827","gray-950":"#030712","zinc-50":"#FAFAFA","zinc-100":"#F4F4F5","zinc-200":"#E4E4E7","zinc-300":"#D4D4D8","zinc-400":"#A1A1AA","zinc-500":"#71717A","zinc-600":"#52525B","zinc-700":"#3F3F46","zinc-800":"#27272A","zinc-900":"#18181B","zinc-950":"#09090B","neutral-50":"#FAFAFA","neutral-100":"#F5F5F5","neutral-200":"#E5E5E5","neutral-300":"#D4D4D4","neutral-400":"#A3A3A3","neutral-500":"#737373","neutral-600":"#525252","neutral-700":"#404040","neutral-800":"#262626","neutral-900":"#171717","neutral-950":"#0A0A0A","stone-50":"#FAFAF9","stone-100":"#F5F5F4","stone-200":"#E7E5E4","stone-300":"#D6D3D1","stone-400":"#A8A29E","stone-500":"#78716C","stone-600":"#57534E","stone-700":"#44403C","stone-800":"#292524","stone-900":"#1C1917","stone-950":"#0C0A09"},zIndex:{base:"0",low:"10",mid:"50",high:"100",top:"9999"}},extend:{}};function He(r,l,t=new WeakSet){if(t.has(r)||t.has(l))return l;t.add(r),t.add(l);let e={...r};for(let i of Object.keys(l))l[i]&&typeof l[i]=="object"&&!Array.isArray(l[i])?e[i]=He(e[i]||{},l[i],t):e[i]=l[i];return e}function We(r={}){let l={...ht};return r.content&&(l.content=r.content),r.output&&(l.output={...l.output,...r.output}),r.darkMode!==void 0&&(l.darkMode=r.darkMode),r.preflight!==void 0&&(l.preflight=r.preflight),r.theme&&(l.theme=He(l.theme,r.theme)),l}(function(){"use strict";function r(a){return!(!a||typeof a!="object"||Array.isArray(a)||a.theme&&(typeof a.theme!="object"||Array.isArray(a.theme)))}function l(){let a=document.querySelector('script[type="senangstart/config"]');if(!a)return{};try{let s=JSON.parse(a.textContent);return r(s)?s:(console.error("[SenangStart] Invalid config structure"),{})}catch(s){return console.error("[SenangStart] Invalid config JSON:",s),{}}}function t(){let a=l();return We(a)}function e(){let a={layout:new Set,space:new Set,visual:new Set,interact:new Set,listens:new Set};return document.querySelectorAll("[layout], [space], [visual], [interact], [listens]").forEach(o=>{["layout","space","visual"].forEach(n=>{let p=o.getAttribute(n);p&&p.split(/\s+/).forEach(c=>{c&&a[n].add(c)})}),["interact","listens"].forEach(n=>{let p=o.getAttribute(n);p&&p.split(/\s+/).forEach(c=>{c&&a[n].add(c)})})}),a}function i(a,s){let o=C(a);return Je(o,s)}function d(a){let s=document.getElementById("senangstart-jit");s||(s=document.createElement("style"),s.id="senangstart-jit",document.head.appendChild(s)),s.textContent=a}function u(){let a=t(),s=e(),o=i(s,a);d(o),new MutationObserver(()=>{let p=e(),c=i(p,a);d(c)}).observe(document.body,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["layout","space","visual","interact","listens"]}),console.log("%c[SenangStart CSS]%c Just-in-Time runtime initialized \u2713","color: #2563EB; font-weight: bold;","color: #10B981;")}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",u):u()})();})();
