...
(()=>{var k=["mob","tab","lap","desk","tw-sm","tw-md","tw-lg","tw-xl","tw-2xl"],M=["hover","focus","focus-visible","active","disabled","dark","expanded","selected"],P=["flex","grid","block","inline","hidden","row","col","row-reverse","col-reverse","center","start","end","between","around","evenly","wrap","nowrap","absolute","relative","fixed","sticky","hoverable","focusable","pressable","expandable","selectable","disabled"];function A(l){if(typeof l!="string")return"";let g=/[;]/g;return g.test(l)?l.replace(g,"_"):l}function aa(l){return!(!l.property||typeof l.property!="string"||l.property.length>100||l.value!==null&&typeof l.value!="string"||l.value&&l.value.length>500||l.breakpoint&&!k.includes(l.breakpoint)||l.state&&!M.includes(l.state))}function T(l,g){if(typeof l!="string"||l.length===0||l.length>200)return{raw:l,breakpoint:null,state:null,property:null,value:null,isArbitrary:!1,attrType:g,error:"Invalid token format"};let p={raw:l,breakpoint:null,state:null,property:null,value:null,isArbitrary:!1,attrType:g};if(g==="layout"){if(l.startsWith("z:"))return p.property="z",p.value=l.substring(2),p;if(l.startsWith("overflow:"))return p.property="overflow",p.value=l.substring(9),p;if(P.includes(l))return p.property=l,p.value=l,p;let y=l.split(":");if(y.length===2&&k.includes(y[0]))return p.breakpoint=y[0],p.property=y[1],p.value=y[1],p}let h=l.split(":");if(h.length===1)return p.property=l,p.value=l,p;let x=0;if(k.includes(h[0])&&(p.breakpoint=h[0],x++),M.includes(h[x])&&(p.state=h[x],x++),x<h.length&&(p.property=h[x],x++),x<h.length){let y=h.slice(x).join(":"),f=y.match(/^\[(.+)\]$/);f?(p.value=A(f[1].replace(/_/g," ")),p.isArbitrary=!0):p.value=A(y)}return aa(p)||(p.error="Invalid token structure"),p}function K(l){return`/* 
...
</div>`,highlightValue:"flex:auto"}]},O={name:"flex-basis",property:"layout",syntax:'layout="basis:[value]"',description:"Set initial size of flex item",descriptionMs:"Tetapkan saiz awal item flex",category:"layout",usesScale:"spacing",supportsArbitrary:!0,dynamic:!0,values:[{value:"auto",css:"flex-basis: auto;",description:"Auto basis",descriptionMs:"Asas automatik"},{value:"0",css:"flex-basis: 0;",description:"Zero basis",descriptionMs:"Asas sifar"}],examples:[{code:'<div layout="basis:[200px]">200px basis</div>',description:"Fixed basis"}],preview:[{title:"Fixed Basis",titleMs:"Asas Tetap",description:"Items with different basis sizes",descriptionMs:"Item dengan saiz asas berbeza",html:`<div layout="flex" space="g:small p:medium" visual="bg:neutral-100 dark:bg:neutral-900 rounded:medium">
...
</div>`,highlightValue:"col-span:full"}]},se={name:"grid-row-span",property:"layout",syntax:'layout="row-span:[value]"',description:"Span across grid rows",descriptionMs:"Merentangi baris grid",category:"layout",dynamic:!0,values:[{value:"1-12",css:"grid-row: span {n} / span {n};",description:"Span N rows",descriptionMs:"Merentangi N baris"},{value:"full",css:"grid-row: 1 / -1;",description:"Span all rows",descriptionMs:"Merentangi semua baris"}],examples:[{code:'<div layout="row-span:2">Spans 2 rows</div>',description:"Span two rows"}],preview:[{title:"Row Span",titleMs:"Rentang Baris",description:"Item spanning multiple rows",descriptionMs:"Item merentangi berbilang baris",html:`<div layout="grid grid-cols:3 grid-rows:2" space="g:small p:medium" visual="bg:neutral-100 dark:bg:neutral-900 rounded:medium">
...
</div>`,highlightValue:"w:[100%]"},{title:"Content-Based Sizing",titleMs:"Saiz Berdasarkan Kandungan",description:"Use min, max, or fit for content-based sizing",descriptionMs:"Guna min, max, atau fit untuk saiz berdasarkan kandungan",html:`<div space="p:medium" visual="bg:neutral-100 dark:bg:neutral-900 rounded:medium">
...
</div>`,highlightValue:"mix-blend:multiply"}]},Ca={name:"accent-color",property:"visual",syntax:'visual="accent:[color]"',description:"Set accent color for form controls",descriptionMs:"Tetapkan warna aksen untuk kawalan borang",category:"visual",usesScale:"colors",supportsArbitrary:!0,values:[],examples:[{code:'<input type="checkbox" visual="accent:primary">',description:"Primary accent"}],preview:[{title:"Accent Color",titleMs:"Warna Aksen",description:"Style native form controls (checkboxes, radios, range)",descriptionMs:"Gaya kawalan borang asli (kotak semak, radio, julat)",html:`<div layout="flex" space="g:medium p:medium" visual="bg:neutral-100 dark:bg:neutral-900 rounded:medium">
...
</div>`,highlightValue:"from:blue-500"}]},Xa={name:"gradient-via",property:"visual",syntax:'visual="via:[color]"',description:"Set gradient middle color",descriptionMs:"Tetapkan warna tengah gradien",category:"visual",usesScale:"colors",supportsArbitrary:!0,values:[{value:"purple-500",css:"--tw-gradient-via: var(--c-purple-500); --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-via), var(--tw-gradient-to);",description:"Via purple",descriptionMs:"Melalui ungu"}],examples:[{code:'<div visual="bg-image:gradient-to-r from:blue-500 via:purple-500 to:pink-500">Three-color gradient</div>',description:"Three-color gradient"}],preview:[{title:"Gradient Via",titleMs:"Pertengahan Gradien",description:"Add a middle color stop to gradients",descriptionMs:"Tambah hentian warna tengah pada gradien",html:`<div layout="flex" space="g:medium p:medium" visual="bg:neutral-100 dark:bg:neutral-900 rounded:medium">
...
</div>`,highlightValue:"break-words"}]},bi={name:"hyphens",property:"visual",syntax:'visual="hyphens:[value]"',description:"Control hyphenation",descriptionMs:"Kawal tanda sempang",category:"visual",values:[{value:"none",css:"hyphens: none;",description:"No hyphens",descriptionMs:"Tiada sempang"},{value:"manual",css:"hyphens: manual;",description:"Manual hyphens",descriptionMs:"Sempang manual"},{value:"auto",css:"hyphens: auto;",description:"Auto hyphens",descriptionMs:"Sempang automatik"}],examples:[{code:'<p visual="hyphens:auto">Automatic hyphenation</p>',description:"Auto hyphens"}],preview:[{title:"Hyphens",titleMs:"Sempang",description:"Control automatic hyphenation",descriptionMs:"Kawal sempang automatik",html:`<div layout="flex" space="g:medium p:medium" visual="bg:neutral-100 dark:bg:neutral-900 rounded:medium">
...
</div>`,highlightValue:"grayscale:full"}]},Pi={name:"filter-hue-rotate",property:"visual",syntax:'visual="hue-rotate:[degrees]"',description:"Rotate hue colors",descriptionMs:"Putar warna rona",category:"visual",supportsArbitrary:!0,dynamic:!0,values:[{value:"0",css:"filter: hue-rotate(0deg);",description:"No rotation",descriptionMs:"Tiada putaran"},{value:"90",css:"filter: hue-rotate(90deg);",description:"90\xB0 rotation",descriptionMs:"Putaran 90\xB0"},{value:"180",css:"filter: hue-rotate(180deg);",description:"180\xB0 rotation",descriptionMs:"Putaran 180\xB0"}],examples:[{code:'<img visual="hue-rotate:90">Shifted hue</img>',description:"Rotate hue 90 degrees"}],preview:[{title:"Hue Rotate Filter",titleMs:"Penapis Putaran Rona",description:"Rotate color hues",descriptionMs:"Putar rona warna",html:`<div layout="flex" space="g:medium p:medium" visual="bg:neutral-100 dark:bg:neutral-900 rounded:medium">
  <div space="p:small" visual="bg:primary text:white rounded:small">0\xB0</div>
...
</div>`,highlightValue:"stroke-w:2"}]},qe={svgFill:vt,svgStroke:gt,svgStrokeWidth:bt},Xe=qe;var Es={...Ve,...ze,...Be,...Ee,...Ke,...Ie,...Ne,...Oe,...He,...Ue,...Xe};function Ye(){return{layoutMap:C(),spacePropertyMap:V(),typographyKeywords:D()}}(function(){"use strict";let l={theme:{spacing:{none:"0px",thin:"1px",regular:"2px",thick:"3px",tiny:"4px","tiny-2x":"6px",small:"8px","small-2x":"10px","small-3x":"12px","small-4x":"14px",medium:"16px","medium-2x":"20px","medium-3x":"24px","medium-4x":"28px",large:"32px","large-2x":"36px","large-3x":"40px","large-4x":"44px",big:"48px","big-2x":"56px","big-3x":"64px","big-4x":"80px",giant:"96px","giant-2x":"112px","giant-3x":"128px","giant-4x":"144px",vast:"160px","vast-2x":"176px","vast-3x":"192px","vast-4x":"208px","vast-5x":"224px","vast-6x":"240px","vast-7x":"256px","vast-8x":"288px","vast-9x":"320px","vast-10x":"384px"},radius:{none:"0px",small:"4px",medium:"8px",big:"16px",round:"9999px"},shadow:{none:"none",small:"0 1px 2px rgba(0,0,0,0.05)",medium:"0 4px 6px rgba(0,0,0,0.1)",big:"0 10px 15px rgba(0,0,0,0.15)",giant:"0 25px 50px rgba(0,0,0,0.25)"},fontSize:{mini:"0.75rem",small:"0.875rem",base:"1rem",large:"1.125rem",big:"1.25rem",huge:"1.5rem",grand:"1.875rem",giant:"2.25rem",mount:"3rem",mega:"3.75rem",giga:"4.5rem",tera:"6rem",hero:"8rem"},fontSizeLineHeight:{mini:"1rem",small:"1.25rem",base:"1.5rem",large:"1.75rem",big:"1.75rem",huge:"2rem",grand:"2.25rem",giant:"2.5rem",mount:"1",mega:"1",giga:"1",tera:"1",hero:"1"},fontWeight:{normal:"400",medium:"500",bold:"700"},screens:{mob:"480px",tab:"768px",lap:"1024px",desk:"1280px","tw-sm":"640px","tw-md":"768px","tw-lg":"1024px","tw-xl":"1280px","tw-2xl":"1536px"},colors:{white:"#FFFFFF",black:"#000000",grey:"#6B7280",dark:"#3E4A5D",light:"#DBEAFE",primary:"#2563EB",secondary:"#DBEAFE",success:"#10B981",warning:"#F59E0B",danger:"#EF4444","red-50":"#FEF2F2","red-100":"#FEE2E2","red-200":"#FECACA","red-300":"#FCA5A5","red-400":"#F87171","red-500":"#EF4444","red-600":"#DC2626","red-700":"#B91C1C","red-800":"#991B1B","red-900":"#7F1D1D","red-950":"#450A0A","orange-50":"#FFF7ED","orange-100":"#FFEDD5","orange-200":"#FED7AA","orange-300":"#FDBA74","orange-400":"#FB923C","orange-500":"#F97316","orange-600":"#EA580C","orange-700":"#C2410C","orange-800":"#9A3412","orange-900":"#7C2D12","orange-950":"#431407","amber-50":"#FFFBEB","amber-100":"#FEF3C7","amber-200":"#FDE68A","amber-300":"#FCD34D","amber-400":"#FBBF24","amber-500":"#F59E0B","amber-600":"#D97706","amber-700":"#B45309","amber-800":"#92400E","amber-900":"#78350F","amber-950":"#451A03","yellow-50":"#FEFCE8","yellow-100":"#FEF9C3","yellow-200":"#FEF08A","yellow-300":"#FDE047","yellow-400":"#FACC15","yellow-500":"#EAB308","yellow-600":"#CA8A04","yellow-700":"#A16207","yellow-800":"#854D0E","yellow-900":"#713F12","yellow-950":"#422006","lime-50":"#F7FEE7","lime-100":"#ECFCCB","lime-200":"#D9F99D","lime-300":"#BEF264","lime-400":"#A3E635","lime-500":"#84CC16","lime-600":"#65A30D","lime-700":"#4D7C0F","lime-800":"#3F6212","lime-900":"#365314","lime-950":"#1A2E05","green-50":"#F0FDF4","green-100":"#DCFCE7","green-200":"#BBF7D0","green-300":"#86EFAC","green-400":"#4ADE80","green-500":"#22C55E","green-600":"#16A34A","green-700":"#15803D","green-800":"#166534","green-900":"#14532D","green-950":"#052E16","emerald-50":"#ECFDF5","emerald-100":"#D1FAE5","emerald-200":"#A7F3D0","emerald-300":"#6EE7B7","emerald-400":"#34D399","emerald-500":"#10B981","emerald-600":"#059669","emerald-700":"#047857","emerald-800":"#065F46","emerald-900":"#064E3B","emerald-950":"#022C22","teal-50":"#F0FDFA","teal-100":"#CCFBF1","teal-200":"#99F6E4","teal-300":"#5EEAD4","teal-400":"#2DD4BF","teal-500":"#14B8A6","teal-600":"#0D9488","teal-700":"#0F766E","teal-800":"#115E59","teal-900":"#134E4A","teal-950":"#042F2E","cyan-50":"#ECFEFF","cyan-100":"#CFFAFE","cyan-200":"#A5F3FC","cyan-300":"#67E8F9","cyan-400":"#22D3EE","cyan-500":"#06B6D4","cyan-600":"#0891B2","cyan-700":"#0E7490","cyan-800":"#155E75","cyan-900":"#164E63","cyan-950":"#083344","sky-50":"#F0F9FF","sky-100":"#E0F2FE","sky-200":"#BAE6FD","sky-300":"#7DD3FC","sky-400":"#38BDF8","sky-500":"#0EA5E9","sky-600":"#0284C7","sky-700":"#0369A1","sky-800":"#075985","sky-900":"#0C4A6E","sky-950":"#082F49","blue-50":"#EFF6FF","blue-100":"#DBEAFE","blue-200":"#BFDBFE","blue-300":"#93C5FD","blue-400":"#60A5FA","blue-500":"#3B82F6","blue-600":"#2563EB","blue-700":"#1D4ED8","blue-800":"#1E40AF","blue-900":"#1E3A8A","blue-950":"#172554","indigo-50":"#EEF2FF","indigo-100":"#E0E7FF","indigo-200":"#C7D2FE","indigo-300":"#A5B4FC","indigo-400":"#818CF8","indigo-500":"#6366F1","indigo-600":"#4F46E5","indigo-700":"#4338CA","indigo-800":"#3730A3","indigo-900":"#312E81","indigo-950":"#1E1B4B","violet-50":"#F5F3FF","violet-100":"#EDE9FE","violet-200":"#DDD6FE","violet-300":"#C4B5FD","violet-400":"#A78BFA","violet-500":"#8B5CF6","violet-600":"#7C3AED","violet-700":"#6D28D9","violet-800":"#5B21B6","violet-900":"#4C1D95","violet-950":"#2E1065","purple-50":"#FAF5FF","purple-100":"#F3E8FF","purple-200":"#E9D5FF","purple-300":"#D8B4FE","purple-400":"#C084FC","purple-500":"#A855F7","purple-600":"#9333EA","purple-700":"#7E22CE","purple-800":"#6B21A8","purple-900":"#581C87","purple-950":"#3B0764","fuchsia-50":"#FDF4FF","fuchsia-100":"#FAE8FF","fuchsia-200":"#F5D0FE","fuchsia-300":"#F0ABFC","fuchsia-400":"#E879F9","fuchsia-500":"#D946EF","fuchsia-600":"#C026D3","fuchsia-700":"#A21CAF","fuchsia-800":"#86198F","fuchsia-900":"#701A75","fuchsia-950":"#4A044E","pink-50":"#FDF2F8","pink-100":"#FCE7F3","pink-200":"#FBCFE8","pink-300":"#F9A8D4","pink-400":"#F472B6","pink-500":"#EC4899","pink-600":"#DB2777","pink-700":"#BE185D","pink-800":"#9D174D","pink-900":"#831843","pink-950":"#500724","rose-50":"#FFF1F2","rose-100":"#FFE4E6","rose-200":"#FECDD3","rose-300":"#FDA4AF","rose-400":"#FB7185","rose-500":"#F43F5E","rose-600":"#E11D48","rose-700":"#BE123C","rose-800":"#9F1239","rose-900":"#881337","rose-950":"#4C0519","slate-50":"#F8FAFC","slate-100":"#F1F5F9","slate-200":"#E2E8F0","slate-300":"#CBD5E1","slate-400":"#94A3B8","slate-500":"#64748B","slate-600":"#475569","slate-700":"#334155","slate-800":"#1E293B","slate-900":"#0F172A","slate-950":"#020617","gray-50":"#F9FAFB","gray-100":"#F3F4F6","gray-200":"#E5E7EB","gray-300":"#D1D5DB","gray-400":"#9CA3AF","gray-500":"#6B7280","gray-600":"#4B5563","gray-700":"#374151","gray-800":"#1F2937","gray-900":"#111827","gray-950":"#030712","zinc-50":"#FAFAFA","zinc-100":"#F4F4F5","zinc-200":"#E4E4E7","zinc-300":"#D4D4D8","zinc-400":"#A1A1AA","zinc-500":"#71717A","zinc-600":"#52525B","zinc-700":"#3F3F46","zinc-800":"#27272A","zinc-900":"#18181B","zinc-950":"#09090B","neutral-50":"#FAFAFA","neutral-100":"#F5F5F5","neutral-200":"#E5E5E5","neutral-300":"#D4D4D4","neutral-400":"#A3A3A3","neutral-500":"#737373","neutral-600":"#525252","neutral-700":"#404040","neutral-800":"#262626","neutral-900":"#171717","neutral-950":"#0A0A0A","stone-50":"#FAFAF9","stone-100":"#F5F5F4","stone-200":"#E7E5E4","stone-300":"#D6D3D1","stone-400":"#A8A29E","stone-500":"#78716C","stone-600":"#57534E","stone-700":"#44403C","stone-800":"#292524","stone-900":"#1C1917","stone-950":"#0C0A09"},zIndex:{base:"0",low:"10",mid:"50",high:"100",top:"9999"},ring:{none:"0px",thin:"1px",regular:"2px",thick:"3px",small:"4px",medium:"6px",big:"8px"}},darkMode:"media",preflight:!0},g={theme:{type:"object",properties:{spacing:{type:"object"},radius:{type:"object"},shadow:{type:"object"},fontSize:{type:"object"},fontWeight:{type:"object"},screens:{type:"object"},colors:{type:"object"},zIndex:{type:"object"},ring:{type:"object"}}},darkMode:{type:"string",enum:["media","selector"]},preflight:{type:"boolean"}};function p(s){return!(!s||typeof s!="object"||Array.isArray(s)||s.theme&&(typeof s.theme!="object"||Array.isArray(s.theme))||s.darkMode!==void 0&&s.darkMode!=="media"&&s.darkMode!=="selector"&&!Array.isArray(s.darkMode)||s.preflight!==void 0&&typeof s.preflight!="boolean")}function h(){let s=document.querySelector('script[type="senangstart/config"]');if(!s)return{};try{let t=JSON.parse(s.textContent);return p(t)?t:(console.error("[SenangStart] Invalid config structure"),{})}catch(t){return console.error("[SenangStart] Invalid config JSON:",t),{}}}function x(s){if(!p(s))return console.error("[SenangStart] Invalid user config, using defaults"),JSON.parse(JSON.stringify(l));let t=JSON.parse(JSON.stringify(l));if(s.theme)for(let e of Object.keys(t.theme))s.theme[e]&&(t.theme[e]={...t.theme[e],...s.theme[e]});return s.darkMode!==void 0&&(t.darkMode=s.darkMode),s.preflight!==void 0&&(t.preflight=s.preflight),t}function y(s){let{theme:t}=s,e=`:root {
`;for(let[d,o]of Object.entries(t.spacing))e+=`  --s-${d}: ${o};
`;for(let[d,o]of Object.entries(t.radius))e+=`  --r-${d}: ${o};
`;for(let[d,o]of Object.entries(t.shadow))e+=`  --shadow-${d}: ${o};
`;for(let[d,o]of Object.entries(t.fontSize))e+=`  --font-${d}: ${o};
`;if(t.fontSizeLineHeight)for(let[d,o]of Object.entries(t.fontSizeLineHeight))e+=`  --font-lh-${d}: ${o};
`;for(let[d,o]of Object.entries(t.fontWeight))e+=`  --fw-${d}: ${o};
`;for(let[d,o]of Object.entries(t.colors))e+=`  --c-${d}: ${o};
`;for(let[d,o]of Object.entries(t.zIndex))e+=`  --z-${d}: ${o};
`;if(t.ring)for(let[d,o]of Object.entries(t.ring))e+=`  --ring-${d}: ${o};
`;e+=`  --ring-color: var(--c-primary);
`,e+=`  --ring-offset: 0px;
`,e+=`  --ring-offset-color: #fff;
`;let i={0:"0px",px:"1px","0.5":"0.125rem",1:"0.25rem","1.5":"0.375rem",2:"0.5rem","2.5":"0.625rem",3:"0.75rem","3.5":"0.875rem",4:"1rem",5:"1.25rem",6:"1.5rem",7:"1.75rem",8:"2rem",9:"2.25rem",10:"2.5rem",11:"2.75rem",12:"3rem",14:"3.5rem",16:"4rem",20:"5rem",24:"6rem",28:"7rem",32:"8rem",36:"9rem",40:"10rem",44:"11rem",48:"12rem",52:"13rem",56:"14rem",60:"15rem",64:"16rem",72:"18rem",80:"20rem",96:"24rem"};for(let[d,o]of Object.entries(i))e+=`  --tw-${d}: ${o};
`;let n={none:"0px",sm:"0.125rem",DEFAULT:"0.25rem",md:"0.375rem",lg:"0.5rem",xl:"0.75rem","2xl":"1rem","3xl":"1.5rem",full:"9999px"};for(let[d,o]of Object.entries(n))e+=`  --tw-rounded-${d}: ${o};
`;let u={sm:"0 1px 2px 0 rgb(0 0 0 / 0.05)",DEFAULT:"0 1px 3px 0 rgb(0 0 0 / 0.1), 0 1px 2px -1px rgb(0 0 0 / 0.1)",md:"0 4px 6px -1px rgb(0 0 0 / 0.1), 0 2px 4px -2px rgb(0 0 0 / 0.1)",lg:"0 10px 15px -3px rgb(0 0 0 / 0.1), 0 4px 6px -4px rgb(0 0 0 / 0.1)",xl:"0 20px 25px -5px rgb(0 0 0 / 0.1), 0 8px 10px -6px rgb(0 0 0 / 0.1)","2xl":"0 25px 50px -12px rgb(0 0 0 / 0.25)",inner:"inset 0 2px 4px 0 rgb(0 0 0 / 0.05)",none:"0 0 #0000"};for(let[d,o]of Object.entries(u))e+=`  --tw-shadow-${d}: ${o};
`;let a={xs:"0.75rem",sm:"0.875rem",base:"1rem",lg:"1.125rem",xl:"1.25rem","2xl":"1.5rem","3xl":"1.875rem","4xl":"2.25rem","5xl":"3rem","6xl":"3.75rem","7xl":"4.5rem","8xl":"6rem","9xl":"8rem"};for(let[d,o]of Object.entries(a))e+=`  --tw-text-${d}: ${o};
`;let r={xs:"1rem",sm:"1.25rem",base:"1.5rem",lg:"1.75rem",xl:"1.75rem","2xl":"2rem","3xl":"2.25rem","4xl":"2.5rem","5xl":"1","6xl":"1","7xl":"1","8xl":"1","9xl":"1"};for(let[d,o]of Object.entries(r))e+=`  --tw-leading-${d}: ${o};
`;let m={thin:"100",extralight:"200",light:"300",normal:"400",medium:"500",semibold:"600",bold:"700",extrabold:"800",black:"900"};for(let[d,o]of Object.entries(m))e+=`  --tw-font-${d}: ${o};
`;return e+=`}

`,e}let{layoutMap:f,typographyKeywords:S}=Ye(),ht=k,xt=M;function Ze(s){let{property:t,value:e,isArbitrary:i}=s;if(t===e&&f[t])return f[t];if(t==="container")return"width: 100%; margin-left: auto; margin-right: auto;";if(t==="justify")return`justify-content: ${{start:"flex-start",end:"flex-end",center:"center",between:"space-between",around:"space-around",evenly:"space-evenly",stretch:"stretch"}[e]||e};`;if(t==="justify-items")return`justify-items: ${e};`;if(t==="justify-self")return`justify-self: ${e};`;if(t==="content")return`align-content: ${{start:"flex-start",end:"flex-end",center:"center",between:"space-between",around:"space-around",evenly:"space-evenly",stretch:"stretch"}[e]||e};`;if(t==="items")return`align-items: ${{start:"flex-start",end:"flex-end",center:"center",baseline:"baseline",stretch:"stretch"}[e]||e};`;if(t==="self")return`align-self: ${{auto:"auto",start:"flex-start",end:"flex-end",center:"center",baseline:"baseline",stretch:"stretch"}[e]||e};`;if(t==="place-content")return`place-content: ${{start:"start",end:"end",center:"center",between:"space-between",around:"space-around",evenly:"space-evenly",stretch:"stretch"}[e]||e};`;if(t==="place-items")return`place-items: ${e};`;if(t==="place-self")return`place-self: ${e};`;if(t==="z")return`z-index: var(--z-${e});`;if(t==="overflow")return`overflow: ${e};`;if(t==="overflow-x")return`overflow-x: ${e};`;if(t==="overflow-y")return`overflow-y: ${e};`;if(t==="aspect")return`aspect-ratio: ${i?e.replace(/_/g," "):{square:"1 / 1",video:"16 / 9",auto:"auto"}[e]||e};`;if(t==="object")return`object-fit: ${e};`;if(t==="object-pos")return`object-position: ${i?e.replace(/_/g," "):e};`;if(t==="inset")return`inset: ${i?e:e==="0"?"0":`var(--s-${e})`};`;if(["top","right","bottom","left"].includes(t)){let n=i?e:e==="0"?"0":`var(--s-${e})`;return`${t}: ${n};`}if(t==="inset-x"){let n=i?e:e==="0"?"0":`var(--s-${e})`;return`left: ${n}; right: ${n};`}if(t==="inset-y"){let n=i?e:e==="0"?"0":`var(--s-${e})`;return`top: ${n}; bottom: ${n};`}return t==="cols"?`columns: ${e};`:t==="overscroll"?`overscroll-behavior: ${e};`:t==="overscroll-x"?`overscroll-behavior-x: ${e};`:t==="overscroll-y"?`overscroll-behavior-y: ${e};`:t==="basis"?`flex-basis: ${i?e:`var(--s-${e})`};`:t==="flex"?`flex: ${i?e.replace(/_/g," "):{1:"1 1 0%",auto:"1 1 auto",initial:"0 1 auto",none:"none"}[e]||e};`:t==="order"?`order: ${{first:"-9999",last:"9999",none:"0"}[e]||e};`:t==="grid-cols"?e==="none"?"grid-template-columns: none;":e==="subgrid"?"grid-template-columns: subgrid;":i?`grid-template-columns: ${e.replace(/_/g," ")};`:`grid-template-columns: repeat(${e}, minmax(0, 1fr));`:t==="grid-rows"?e==="none"?"grid-template-rows: none;":e==="subgrid"?"grid-template-rows: subgrid;":i?`grid-template-rows: ${e.replace(/_/g," ")};`:`grid-template-rows: repeat(${e}, minmax(0, 1fr));`:t==="col-span"?e==="full"?"grid-column: 1 / -1;":`grid-column: span ${e} / span ${e};`:t==="col-start"?`grid-column-start: ${e};`:t==="col-end"?`grid-column-end: ${e};`:t==="row-span"?e==="full"?"grid-row: 1 / -1;":`grid-row: span ${e} / span ${e};`:t==="row-start"?`grid-row-start: ${e};`:t==="row-end"?`grid-row-end: ${e};`:t==="auto-cols"?`grid-auto-columns: ${i?e:{auto:"auto",min:"min-content",max:"max-content",fr:"minmax(0, 1fr)"}[e]||e};`:t==="auto-rows"?`grid-auto-rows: ${i?e:{auto:"auto",min:"min-content",max:"max-content",fr:"minmax(0, 1fr)"}[e]||e};`:t==="table"?`table-layout: ${{auto:"auto",fixed:"fixed"}[e]||e};`:t==="caption"?`caption-side: ${e};`:t==="border-spacing"?`border-spacing: ${i?e:`var(--s-${e})`};`:t==="border-spacing-x"?`border-spacing: ${i?e:`var(--s-${e})`} 0;`:t==="border-spacing-y"?`border-spacing: 0 ${i?e:`var(--s-${e})`};`:f[t]||""}function _e(s){let{property:t,value:e,isArbitrary:i}=s;if(e==="auto")return{m:"margin: auto;","m-x":"margin-left: auto; margin-right: auto;","m-y":"margin-top: auto; margin-bottom: auto;","m-t":"margin-top: auto;","m-r":"margin-right: auto;","m-b":"margin-bottom: auto;","m-l":"margin-left: auto;"}[t]||"";let n={min:"min-content",max:"max-content",fit:"fit-content"};if(["w","h","min-w","max-w","min-h","max-h"].includes(t)&&n[e]){let m=n[e];return{w:`width: ${m};`,h:`height: ${m};`,"min-w":`min-width: ${m};`,"max-w":`max-width: ${m};`,"min-h":`min-height: ${m};`,"max-h":`max-height: ${m};`}[t]||""}let a;if(i)a=e;else{let m=e.startsWith("-"),d=m?e.substring(1):e,o;d.startsWith("tw-")?o=`var(--tw-${d.slice(3)})`:o=`var(--s-${d})`,a=m?`calc(${o} * -1)`:o}return{p:`padding: ${a};`,"p-t":`padding-top: ${a};`,"p-r":`padding-right: ${a};`,"p-b":`padding-bottom: ${a};`,"p-l":`padding-left: ${a};`,"p-x":`padding-left: ${a}; padding-right: ${a};`,"p-y":`padding-top: ${a}; padding-bottom: ${a};`,m:`margin: ${a};`,"m-t":`margin-top: ${a};`,"m-r":`margin-right: ${a};`,"m-b":`margin-bottom: ${a};`,"m-l":`margin-left: ${a};`,"m-x":`margin-left: ${a}; margin-right: ${a};`,"m-y":`margin-top: ${a}; margin-bottom: ${a};`,g:`gap: ${a};`,"g-x":`column-gap: ${a};`,"g-y":`row-gap: ${a};`,w:`width: ${a};`,h:`height: ${a};`,"min-w":`min-width: ${a};`,"max-w":`max-width: ${a};`,"min-h":`min-height: ${a};`,"max-h":`max-height: ${a};`}[t]||""}function Qe(s){let{property:t,value:e,isArbitrary:i}=s;if(S[t]||S[t])return S[t];let u={bg:()=>`background-color: ${i?e:`var(--c-${e})`};`,text:()=>["left","center","right","justify"].includes(e)?`text-align: ${e};`:`color: ${i?e:`var(--c-${e})`};`,"text-size":()=>{let a,r;if(i)return a=e,`font-size: ${a};`;if(e.startsWith("tw-")){let m=e.slice(3);a=`var(--tw-text-${m})`,r=`var(--tw-leading-${m})`}else a=`var(--font-${e})`,r=`var(--font-lh-${e})`;return`font-size: ${a}; line-height: ${r};`},font:()=>{let a={sans:"ui-sans-serif, system-ui, sans-serif",serif:"ui-serif, Georgia, serif",mono:"ui-monospace, monospace"};if(a[e])return`font-family: ${a[e]};`;let r;return i?r=e:e.startsWith("tw-")?r=`var(--tw-font-${e.slice(3)})`:r=`var(--fw-${e})`,`font-weight: ${r};`},tracking:()=>`letter-spacing: ${i?e:{tighter:"-0.05em",tight:"-0.025em",normal:"0",wide:"0.025em",wider:"0.05em",widest:"0.1em"}[e]||e};`,leading:()=>`line-height: ${i?e:{none:"1",tight:"1.25",snug:"1.375",normal:"1.5",relaxed:"1.625",loose:"2"}[e]||e};`,"line-clamp":()=>`overflow: hidden; display: -webkit-box; -webkit-box-orient: vertical; -webkit-line-clamp: ${e};`,decoration:()=>`text-decoration-color: ${i?e:`var(--c-${e})`};`,"decoration-thickness":()=>`text-decoration-thickness: ${i?e:`${e}px`};`,"underline-offset":()=>`text-underline-offset: ${i?e:`${e}px`};`,indent:()=>`text-indent: ${i?e:`var(--s-${e})`};`,border:()=>`border-color: ${i?e:`var(--c-${e})`}; border-style: solid;`,"border-t":()=>`border-top-color: ${i?e:`var(--c-${e})`}; border-top-style: solid;`,"border-b":()=>`border-bottom-color: ${i?e:`var(--c-${e})`}; border-bottom-style: solid;`,"border-l":()=>`border-left-color: ${i?e:`var(--c-${e})`}; border-left-style: solid;`,"border-r":()=>`border-right-color: ${i?e:`var(--c-${e})`}; border-right-style: solid;`,"border-x":()=>{let a=i?e:`var(--c-${e})`;return`border-left-color: ${a}; border-right-color: ${a}; border-left-style: solid; border-right-style: solid;`},"border-y":()=>{let a=i?e:`var(--c-${e})`;return`border-top-color: ${a}; border-bottom-color: ${a}; border-top-style: solid; border-bottom-style: solid;`},"border-w":()=>`border-width: ${i?e:`var(--s-${e})`}; border-style: solid;`,"border-t-w":()=>`border-top-width: ${i?e:`var(--s-${e})`}; border-top-style: solid;`,"border-b-w":()=>`border-bottom-width: ${i?e:`var(--s-${e})`}; border-bottom-style: solid;`,"border-l-w":()=>`border-left-width: ${i?e:`var(--s-${e})`}; border-left-style: solid;`,"border-r-w":()=>`border-right-width: ${i?e:`var(--s-${e})`}; border-right-style: solid;`,"border-x-w":()=>{let a=i?e:`var(--s-${e})`;return`border-left-width: ${a}; border-right-width: ${a}; border-left-style: solid; border-right-style: solid;`},"border-y-w":()=>{let a=i?e:`var(--s-${e})`;return`border-top-width: ${a}; border-bottom-width: ${a}; border-top-style: solid; border-bottom-style: solid;`},rounded:()=>{let a;return i?a=e:e.startsWith("tw-")?a=`var(--tw-rounded-${e.slice(3)})`:a=`var(--r-${e})`,`border-radius: ${a};`},shadow:()=>{let a;return i?a=e:e.startsWith("tw-")?a=`var(--tw-shadow-${e.slice(3)})`:a=`var(--shadow-${e})`,`box-shadow: ${a};`},opacity:()=>`opacity: ${i?e:parseFloat(e)/100};`,content:()=>`content: "${e}";`,scale:()=>`transform: scale(${i?e:parseFloat(e)/100});`,"scale-x":()=>`transform: scaleX(${i?e:parseFloat(e)/100});`,"scale-y":()=>`transform: scaleY(${i?e:parseFloat(e)/100});`,rotate:()=>`transform: rotate(${i?e:`${e}deg`});`,"translate-x":()=>`transform: translateX(${i?e:{0:"0",full:"100%","1/2":"50%","-full":"-100%","-1/2":"-50%"}[e]||`var(--s-${e})`});`,"translate-y":()=>`transform: translateY(${i?e:{0:"0",full:"100%","1/2":"50%","-full":"-100%","-1/2":"-50%"}[e]||`var(--s-${e})`});`,"skew-x":()=>`transform: skewX(${i?e:`${e}deg`});`,"skew-y":()=>`transform: skewY(${i?e:`${e}deg`});`,origin:()=>`transform-origin: ${i?e.replace(/_/g," "):{center:"center",top:"top","top-right":"top right",right:"right","bottom-right":"bottom right",bottom:"bottom","bottom-left":"bottom left",left:"left","top-left":"top left"}[e]||e};`,transition:()=>({none:"transition-property: none;",all:"transition-property: all; transition-timing-function: cubic-bezier(0.4, 0, 0.2, 1); transition-duration: 150ms;",colors:"transition-property: color, background-color, border-color; transition-timing-function: cubic-bezier(0.4, 0, 0.2, 1); transition-duration: 150ms;",opacity:"transition-property: opacity; transition-timing-function: cubic-bezier(0.4, 0, 0.2, 1); transition-duration: 150ms;",shadow:"transition-property: box-shadow; transition-timing-function: cubic-bezier(0.4, 0, 0.2, 1); transition-duration: 150ms;",transform:"transition-property: transform; transition-timing-function: cubic-bezier(0.4, 0, 0.2, 1); transition-duration: 150ms;"})[e]||`transition-property: ${e};`,duration:()=>`transition-duration: ${i?e:{instant:"75ms",quick:"100ms",fast:"150ms",normal:"200ms",slow:"300ms",slower:"500ms",lazy:"700ms"}[e]||`${e}ms`};`,ease:()=>`transition-timing-function: ${{linear:"linear",in:"cubic-bezier(0.4, 0, 1, 1)",out:"cubic-bezier(0, 0, 0.2, 1)","in-out":"cubic-bezier(0.4, 0, 0.2, 1)"}[e]||e};`,delay:()=>`transition-delay: ${i?e:{instant:"75ms",quick:"100ms",fast:"150ms",normal:"200ms",slow:"300ms"}[e]||`${e}ms`};`,animate:()=>({none:"animation: none;",spin:"animation: spin 1s linear infinite;",ping:"animation: ping 1s cubic-bezier(0, 0, 0.2, 1) infinite;",pulse:"animation: pulse 2s cubic-bezier(0.4, 0, 0.6, 1) infinite;",bounce:"animation: bounce 1s infinite;"})[e]||`animation: ${e};`,blur:()=>`filter: blur(${i?e:{none:"0",sm:"4px",md:"8px",lg:"12px",xl:"16px","2xl":"24px","3xl":"40px"}[e]||`${e}px`});`,brightness:()=>`filter: brightness(${i?e:{0:"0",50:"0.5",75:"0.75",90:"0.9",95:"0.95",100:"1",105:"1.05",110:"1.1",125:"1.25",150:"1.5",200:"2"}[e]||parseFloat(e)/100});`,contrast:()=>`filter: contrast(${i?e:{0:"0",50:"0.5",75:"0.75",100:"1",125:"1.25",150:"1.5",200:"2"}[e]||parseFloat(e)/100});`,grayscale:()=>`filter: grayscale(${i?e:{0:"0",100:"1",full:"1"}[e]||parseFloat(e)/100});`,"hue-rotate":()=>`filter: hue-rotate(${i?e:`${e}deg`});`,invert:()=>`filter: invert(${i?e:{0:"0",100:"1",full:"1"}[e]||parseFloat(e)/100});`,saturate:()=>`filter: saturate(${i?e:{0:"0",50:"0.5",100:"1",150:"1.5",200:"2"}[e]||parseFloat(e)/100});`,sepia:()=>`filter: sepia(${i?e:{0:"0",100:"1",full:"1"}[e]||parseFloat(e)/100});`,"drop-shadow":()=>{let a={sm:"drop-shadow(0 1px 1px rgb(0 0 0 / 0.05))",md:"drop-shadow(0 4px 3px rgb(0 0 0 / 0.07)) drop-shadow(0 2px 2px rgb(0 0 0 / 0.06))",lg:"drop-shadow(0 10px 8px rgb(0 0 0 / 0.04)) drop-shadow(0 4px 3px rgb(0 0 0 / 0.1))",xl:"drop-shadow(0 20px 13px rgb(0 0 0 / 0.03)) drop-shadow(0 8px 5px rgb(0 0 0 / 0.08))","2xl":"drop-shadow(0 25px 25px rgb(0 0 0 / 0.15))",none:"drop-shadow(0 0 #0000)"};return`filter: ${i?`drop-shadow(${e.replace(/_/g," ")})`:a[e]||a.md};`},"bg-size":()=>`background-size: ${i?e.replace(/_/g," "):{auto:"auto",cover:"cover",contain:"contain"}[e]||e};`,"bg-pos":()=>`background-position: ${i?e.replace(/_/g," "):{center:"center",top:"top","top-right":"top right",right:"right","bottom-right":"bottom right",bottom:"bottom","bottom-left":"bottom left",left:"left","top-left":"top left"}[e]||e};`,"bg-repeat":()=>`background-repeat: ${{repeat:"repeat","no-repeat":"no-repeat","repeat-x":"repeat-x","repeat-y":"repeat-y",round:"round",space:"space"}[e]||e};`,"bg-attachment":()=>`background-attachment: ${e};`,"bg-clip":()=>`background-clip: ${{border:"border-box",padding:"padding-box",content:"content-box",text:"text"}[e]||e};`,"bg-origin":()=>`background-origin: ${{border:"border-box",padding:"padding-box",content:"content-box"}[e]||e};`,"bg-blend":()=>`background-blend-mode: ${e};`,"bg-image":()=>`background-image: ${i?e.replace(/_/g," "):{none:"none","gradient-to-t":"linear-gradient(to top, var(--tw-gradient-stops))","gradient-to-tr":"linear-gradient(to top right, var(--tw-gradient-stops))","gradient-to-r":"linear-gradient(to right, var(--tw-gradient-stops))","gradient-to-br":"linear-gradient(to bottom right, var(--tw-gradient-stops))","gradient-to-b":"linear-gradient(to bottom, var(--tw-gradient-stops))","gradient-to-bl":"linear-gradient(to bottom left, var(--tw-gradient-stops))","gradient-to-l":"linear-gradient(to left, var(--tw-gradient-stops))","gradient-to-tl":"linear-gradient(to top left, var(--tw-gradient-stops))"}[e]||e};`,from:()=>`--tw-gradient-from: ${i?e:`var(--c-${e})`}; --tw-gradient-to: transparent; --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);`,via:()=>`--tw-gradient-via: ${i?e:`var(--c-${e})`}; --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-via), var(--tw-gradient-to);`,to:()=>`--tw-gradient-to: ${i?e:`var(--c-${e})`};`,"backdrop-blur":()=>`backdrop-filter: blur(${i?e:{none:"0",sm:"4px",md:"8px",lg:"12px",xl:"16px","2xl":"24px","3xl":"40px"}[e]||`${e}px`});`,"backdrop-brightness":()=>`backdrop-filter: brightness(${i?e:parseFloat(e)/100});`,"backdrop-contrast":()=>`backdrop-filter: contrast(${i?e:parseFloat(e)/100});`,"backdrop-grayscale":()=>`backdrop-filter: grayscale(${i?e:{0:"0",100:"1",full:"1"}[e]||parseFloat(e)/100});`,"backdrop-hue-rotate":()=>`backdrop-filter: hue-rotate(${i?e:`${e}deg`});`,"backdrop-invert":()=>`backdrop-filter: invert(${i?e:{0:"0",100:"1",full:"1"}[e]||parseFloat(e)/100});`,"backdrop-opacity":()=>`backdrop-filter: opacity(${i?e:parseFloat(e)/100});`,"backdrop-saturate":()=>`backdrop-filter: saturate(${i?e:parseFloat(e)/100});`,"backdrop-sepia":()=>`backdrop-filter: sepia(${i?e:{0:"0",100:"1",full:"1"}[e]||parseFloat(e)/100});`,"animation-duration":()=>`animation-duration: ${i?e:{instant:"75ms",quick:"100ms",fast:"150ms",normal:"200ms",slow:"300ms",slower:"500ms",lazy:"700ms"}[e]||`${e}ms`};`,"animation-delay":()=>`animation-delay: ${i?e:{instant:"75ms",quick:"100ms",fast:"150ms",normal:"200ms",slow:"300ms"}[e]||`${e}ms`};`,"animation-iteration":()=>`animation-iteration-count: ${{infinite:"infinite",once:"1",twice:"2"}[e]||e};`,"animation-direction":()=>`animation-direction: ${e};`,"animation-fill":()=>`animation-fill-mode: ${e};`,"animation-play":()=>`animation-play-state: ${e};`,"animation-timing":()=>`animation-timing-function: ${{linear:"linear",in:"cubic-bezier(0.4, 0, 1, 1)",out:"cubic-bezier(0, 0, 0.2, 1)","in-out":"cubic-bezier(0.4, 0, 0.2, 1)"}[e]||e};`,"scroll-behavior":()=>`scroll-behavior: ${e};`,"scroll-m":()=>`scroll-margin: ${i?e:`var(--s-${e})`};`,"scroll-m-x":()=>{let a=i?e:`var(--s-${e})`;return`scroll-margin-left: ${a}; scroll-margin-right: ${a};`},"scroll-m-y":()=>{let a=i?e:`var(--s-${e})`;return`scroll-margin-top: ${a}; scroll-margin-bottom: ${a};`},"scroll-p":()=>`scroll-padding: ${i?e:`var(--s-${e})`};`,"scroll-p-x":()=>{let a=i?e:`var(--s-${e})`;return`scroll-padding-left: ${a}; scroll-padding-right: ${a};`},"scroll-p-y":()=>{let a=i?e:`var(--s-${e})`;return`scroll-padding-top: ${a}; scroll-padding-bottom: ${a};`},"snap-align":()=>`scroll-snap-align: ${e};`,"snap-stop":()=>`scroll-snap-stop: ${e};`,"snap-type":()=>`scroll-snap-type: ${{none:"none",x:"x mandatory",y:"y mandatory",both:"both mandatory","x-proximity":"x proximity","y-proximity":"y proximity"}[e]||e};`,touch:()=>`touch-action: ${{auto:"auto",none:"none","pan-x":"pan-x","pan-y":"pan-y","pan-left":"pan-left","pan-right":"pan-right","pan-up":"pan-up","pan-down":"pan-down","pinch-zoom":"pinch-zoom",manipulation:"manipulation"}[e]||e};`,resize:()=>`resize: ${{none:"none",both:"both",x:"horizontal",y:"vertical"}[e]||e};`,"will-change":()=>`will-change: ${{auto:"auto",scroll:"scroll-position",contents:"contents",transform:"transform",opacity:"opacity"}[e]||e};`,"color-scheme":()=>`color-scheme: ${e};`,"field-sizing":()=>`field-sizing: ${e};`,"forced-color":()=>`forced-color-adjust: ${e};`,"border-style":()=>`border-style: ${e};`,outline:()=>`outline-color: ${i?e:`var(--c-${e})`};`,"outline-style":()=>`outline-style: ${e};`,"outline-w":()=>`outline-width: ${i?e:`${e}px`};`,"outline-offset":()=>`outline-offset: ${i?e:`${e}px`};`,ring:()=>e==="none"?"box-shadow: 0 0 0 0 transparent;":`box-shadow: 0 0 0 var(--ring-offset) var(--ring-offset-color), 0 0 0 calc(${i?e:`var(--ring-${e})`} + var(--ring-offset)) var(--ring-color);`,"ring-color":()=>`--ring-color: ${i?e:`var(--c-${e})`};`,"ring-offset":()=>`--ring-offset: ${i?e:`${e}px`};`,"ring-offset-color":()=>`--ring-offset-color ${i?e:`var(--c-${e})`};`,divide:()=>`border-color: ${i?e:`var(--c-${e})`}; border-style: solid;`,"divide-x":()=>{if(e==="reverse")return"--ss-divide-x-reverse: 1;";let a=i?e:`var(--c-${e})`;return`border-left-color: ${a}; border-right-color: ${a}; border-left-style: solid; border-right-style: solid;`},"divide-y":()=>{if(e==="reverse")return"--ss-divide-y-reverse: 1;";let a=i?e:`var(--c-${e})`;return`border-top-color: ${a}; border-bottom-color: ${a}; border-top-style: solid; border-bottom-style: solid;`},"divide-w":()=>`border-width: ${i?e:`var(--s-${e})`}; border-style: solid;`,"divide-x-w":()=>{let a=i?e:`var(--s-${e})`;return`
          border-right-width: calc(${a} * var(--ss-divide-x-reverse, 0));
          border-left-width: calc(${a} * (1 - var(--ss-divide-x-reverse, 0)));
          border-left-style: solid; 
          border-right-style: solid;
        `},"divide-y-w":()=>{let a=i?e:`var(--s-${e})`;return`
          border-bottom-width: calc(${a} * var(--ss-divide-y-reverse, 0));
          border-top-width: calc(${a} * (1 - var(--ss-divide-y-reverse, 0)));
          border-top-style: solid; 
          border-bottom-style: solid;
        `},"divide-x:reverse":()=>"--ss-divide-x-reverse: 1;","divide-y:reverse":()=>"--ss-divide-y-reverse: 1;","divide-style":()=>`border-style: ${e};`,stroke:()=>`stroke: ${i?e:`var(--c-${e})`};`,"stroke-w":()=>`stroke-width: ${e};`,fill:()=>e==="none"?"fill: none;":`fill: ${i?e:`var(--c-${e})`};`,"mix-blend":()=>`mix-blend-mode: ${e};`,perspective:()=>`perspective: ${i?e:{none:"none",sm:"500px",md:"1000px",lg:"1500px",xl:"2000px"}[e]||e};`,"perspective-origin":()=>`perspective-origin: ${i?e.replace(/_/g," "):{center:"center",top:"top","top-right":"top right",right:"right","bottom-right":"bottom right",bottom:"bottom","bottom-left":"bottom left",left:"left","top-left":"top left"}[e]||e};`,"rotate-x":()=>`transform: rotateX(${i?e:`${e}deg`});`,"rotate-y":()=>`transform: rotateY(${i?e:`${e}deg`});`,"rotate-z":()=>`transform: rotateZ(${i?e:`${e}deg`});`,"transform-style":()=>`transform-style: ${e};`,backface:()=>`backface-visibility: ${{visible:"visible",hidden:"hidden"}[e]||e};`}[t];return u?u():""}function F(s,t,e=[]){if(t==="layout"&&f[s])return`[layout~="${s}"] { ${f[s]} }
`;let i=T(s,t),n="";switch(t){case"layout":n=Ze(i);break;case"space":n=_e(i);break;case"visual":n=Qe(i);break}if(!n)return"";let u=s.startsWith("divide")&&!s.includes(":reverse"),a="";if(u?a=`[visual~="${s}"] > :not([hidden]) ~ :not([hidden])`:a=`[${t}~="${s}"]`,i.state&&i.state!=="dark"){let r=i.state;if(u)a=`[visual~="${s}"] > :not([hidden]) ~ :not([hidden]):${r}`;else{a+=`:${r}`;let d={hover:"hoverable",focus:"focusable","focus-within":"focusable",active:"pressable",expanded:"expandable",selected:"selectable"}[r];if(d&&(a+=`, [layout~="${d}"]:${r} [${t}~="${s}"]`,e&&e.length>0))for(let o of e)a+=`, [interact~="${o}"]:${r} ~ [listens~="${o}"][${t}~="${s}"]`}}return`${a} { ${n} }
`}function z(){let s={layout:new Set,space:new Set,visual:new Set,interact:new Set,listens:new Set};return document.querySelectorAll("[layout], [space], [visual], [interact], [listens]").forEach(e=>{["layout","space","visual"].forEach(i=>{let n=e.getAttribute(i);n&&n.split(/\s+/).forEach(u=>{u&&s[i].add(u)})}),["interact","listens"].forEach(i=>{let n=e.getAttribute(i);n&&n.split(/\s+/).forEach(u=>{u&&s[i].add(u)})})}),s}function j(s,t){let e=y(t);t.preflight!==!1&&(e+=K());let i=[];for(let[c,v]of Object.entries(s))if(!["interact","listens"].includes(c))for(let w of v)i.push({raw:w,attrType:c});let n=Array.from(s.interact||[]),u=[],a=[],r={},{screens:m}=t.theme;for(let c of Object.keys(m))r[c]=[];for(let c of i){let v=T(c.raw,c.attrType);v.state==="dark"?a.push(v):v.breakpoint?(r[v.breakpoint]||(r[v.breakpoint]=[]),r[v.breakpoint].push(v)):u.push(v)}let d=["flex","grid","inline-flex","inline-grid","block","inline","hidden","contents"],o=new Map;for(let c of u)c.attrType&&d.includes(c.property)&&(o.has(c.attrType)||o.set(c.attrType,new Set),o.get(c.attrType).add(c.raw));for(let c of u)e+=F(c.raw,c.attrType,n);for(let[c,v]of Object.entries(r))if(v.length>0){e+=`
@media (min-width: ${m[c]}) {
`;let w=new Set;for(let b of v)if(b.attrType&&d.includes(b.property)&&o.has(b.attrType)){let E=o.get(b.attrType);if(E.size>0&&!E.has(b.raw)&&!w.has(b.raw)){let ea=`[${b.attrType}~="${b.raw}"]`;e+=`  ${ea} { display: revert-layer; }
`,w.add(b.raw)}}for(let b of v)e+="  "+F(b.raw,b.attrType,n);e+=`}
`}if(a.length>0){let c=t.darkMode||"media";if(c==="media"){e+=`
@media (prefers-color-scheme: dark) {
`;for(let v of a)e+="  "+F(v.raw,v.attrType,n);e+=`}
`}else{let v=Array.isArray(c)?c[1]:".dark";e+=`
/* Dark Mode */
`;for(let w of a){let b=F(w.raw,w.attrType,n);e+=b.replace(/^(\[[^\]]+\])/,`${v} $1`)}}}return e}function B(s){let t=document.getElementById("senangstart-jit");t||(t=document.createElement("style"),t.id="senangstart-jit",document.head.appendChild(t)),t.textContent=s}function $(){let s=h(),t=x(s),e=z(),i=j(e,t);B(i),new MutationObserver(()=>{let u=z(),a=j(u,t);B(a)}).observe(document.body,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["layout","space","visual","interact","listens"]}),console.log("%c[SenangStart CSS]%c Just-in-Time runtime initialized \u2713","color: #2563EB; font-weight: bold;","color: #10B981;")}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",$):$()})();})();
