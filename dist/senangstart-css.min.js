...
(()=>{var x=["mob","tab","lap","desk","tw-sm","tw-md","tw-lg","tw-xl","tw-2xl"],f=["hover","focus","focus-visible","active","disabled","dark","expanded","selected"],V=["flex","grid","block","inline","hidden","row","col","row-reverse","col-reverse","center","start","end","between","around","evenly","wrap","nowrap","absolute","relative","fixed","sticky","hoverable","focusable","pressable","expandable","selectable","disabled"];function h(n){if(typeof n!="string")return"";let l=/[;]/g;return l.test(n)?n.replace(l,"_"):n}function Xe(n){return!(!n.property||typeof n.property!="string"||n.property.length>100||n.value!==null&&typeof n.value!="string"||n.value&&n.value.length>500||n.breakpoint&&!x.includes(n.breakpoint)||n.state&&!f.includes(n.state))}function Ye(n,l){if(typeof n!="string"||n.length===0||n.length>200)return{raw:n,breakpoint:null,state:null,property:null,value:null,isArbitrary:!1,attrType:l,error:"Invalid token format"};let t={raw:n,breakpoint:null,state:null,property:null,value:null,isArbitrary:!1,attrType:l};if(l==="layout"){if(n.startsWith("z:"))return t.property="z",t.value=n.substring(2),t;if(n.startsWith("overflow:"))return t.property="overflow",t.value=n.substring(9),t;if(V.includes(n))return t.property=n,t.value=n,t;let d=n.split(":");if(d.length===2&&x.includes(d[0]))return t.breakpoint=d[0],t.property=d[1],t.value=d[1],t}let e=n.split(":");if(e.length===1)return t.property=n,t.value=n,t;let i=0;if(x.includes(e[0])&&(t.breakpoint=e[0],i++),f.includes(e[i])&&(t.state=e[i],i++),i<e.length&&(t.property=e[i],i++),i<e.length){let d=e.slice(i).join(":"),c=d.match(/^\[(.+)\]$/);c?(t.value=h(c[1].replace(/_/g," ")),t.isArbitrary=!0):t.value=h(d)}return Xe(t)||(t.error="Invalid token structure"),t}function T(n){let l=[];for(let[t,e]of Object.entries(n))for(let i of e)l.push(Ye(i,t));return l}function C(n){return`/* 
...
</div>`,highlightValue:"stroke-w:2"}]},Le={svgFill:dt,svgStroke:pt,svgStrokeWidth:ut},Ne=Le;var Bs={...ke,...Me,...Ae,...Ve,...Ce,...$e,...je,...Ee,...Ke,...Ie,...Ne};function Ge(){return{layoutMap:k(),spacePropertyMap:w(),typographyKeywords:M()}}var{layoutMap:S,typographyKeywords:Oe}=Ge();function b(n){return h(n)}function ct(n){let{theme:l}=n,t=`:root {
