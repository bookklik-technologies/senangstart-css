...
`;for(let[t,s]of Object.entries(R))a+=`  --tw-${t}: ${s};
`;for(let[t,s]of Object.entries(L))a+=`  --r-tw-${t}: ${s};
`;for(let[t,s]of Object.entries(I))a+=`  --shadow-tw-${t}: ${s};
